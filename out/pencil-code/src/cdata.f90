...
logical, dimension(3) :: lperi=.true.,  lshift_origin=.false., lshift_origin_lower=.false.,  lpole=.false.,  lequidist=.true.
...
double precision :: k_B,m_u,m_p,m_e,m_H,m_He,eV,  chiH,chiH_,sigmaH_,sigmaSB,kappa_es
...
logical :: ldensity_nolog=.false., lwrite_stratification=.false.,  lreference_state=.false., lfullvar_in_slices=.false.,  lsubstract_reference_state=.false.,  ldensity_linearstart=.false.
...
integer :: ibbt=0,ibxt=0,ibyt=0,ibzt=0,ijjt=0,ijxt=0,ijyt=0,ijzt=0,  ijxb=0, ijxbx=0, ijxby=0, ijxbz=0
...
integer :: iFF_diff=0, iFF_diff1=0,  iFF_diff2=0,  iFF_div_uu=0, iFF_div_aa=0, iFF_div_ss=0, iFF_div_rho=0, iFF_char_c=0, iFF_heat=0
...
integer :: idiag_t=0
integer :: idiag_dt=0
integer :: idiag_walltime=0
integer :: idiag_timeperstep=0
integer :: idiag_rcylmphi=0
integer :: idiag_phimphi=0
integer :: idiag_zmphi=0
integer :: idiag_rmphi=0
integer :: idiag_dtv=0
integer :: idiag_dtdiffus=0
integer :: idiag_dtdiffus2=0
integer :: idiag_dtdiffus3=0
integer :: idiag_Rmesh=0
integer :: idiag_Rmesh3=0
integer :: idiag_maxadvec=0
!
