...
write(unit=unit,iostat=iostat,iomsg=iomsg) torus%center,  torus%th,torus%ph,  torus%r_in, torus%thick,  torus%height
...
integer,          intent(OUT)  :: iostat
character(LEN=*), intent(INOUT):: iomsg
read(unit=unit,iostat=iostat,iomsg=iomsg) torus%center,  torus%th,torus%ph,  torus%r_in, torus%thick,  torus%height
