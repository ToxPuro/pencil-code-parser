...
integer :: pushpars2c, pushdiags2c
integer :: iLam=0
!
...
if (lpenc_loc(i_el).or.lpenc_loc(i_e2)) call fatal_error("calc_pencils_magnetic_pencpar", "Electric field is not currently computed in magnetic")
!
