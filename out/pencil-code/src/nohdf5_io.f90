...
subroutine input_dim(wrkdir, mx_in, my_in, mz_in, mvar_in, maux_in, mglobal_in,  prec_in, nghost_in, nprocx_in, nprocy_in, nprocz_in, local)
!
...
logical :: lexist_slice_xy, lexist_slice_xy2, lexist_slice_xy3, lexist_slice_xy4,  lexist_slice_xz, lexist_slice_xz2, lexist_slice_yz
...
if (.not.file_exists(file))  call fatal_error('input_slice', 'no slices file '//trim(file))
