...
use Messages
use EquationOfState, only: get_cp1, cs0, cs20, cs2bot, cs2top, rho0, lnrho0,  gamma, gamma1, gamma_m1
use DensityMethods
!
...
namelist /density_init_pars/  ampllnrho, initlnrho, widthlnrho, rho_left, rho_right, lnrho_const,  Hrho, rho_const, cs2bot, cs2top, radius_lnrho, eps_planet, xblob,  yblob, zblob, b_ell, q_ell, hh0, rbound, lwrite_stratification,  mpoly, ggamma,  strati_type, beta_glnrho_global, kx_lnrho, ky_lnrho, kz_lnrho,  amplrho, phase_lnrho, coeflnrho, kxx_lnrho, kyy_lnrho,  kzz_lnrho,  co1_ss, co2_ss, Sigma1, idiff, ldensity_nolog, wdamp, lcontinuity_gas,  lisothermal_fixed_Hrho, density_floor, lanti_shockdiffusion,  lmassdiff_fix, lmassdiff_fixmom, lmassdiff_fixkin,   lrho_as_aux, ldiffusion_nolog, lnrho_z_shift, powerlr, zoverh, hoverr,  lffree, ffree_profile, rzero_ffree, wffree, rho_top, rho_bottom,  r0_rho, invgrav_ampl, rnoise_int, rnoise_ext, datafile, mass_cloud,  T_cloud, cloud_mode, T_cloud_out_rel, xi_coeff, density_xaver_range,  dens_coeff, temp_coeff, temp_trans, temp_coeff_out, reduce_cs2,  lreduced_sound_speed, lrelativistic_eos,  lscale_to_cs2top, density_zaver_range,  ieos_profile, width_eos_prof,  lconserve_total_mass, total_mass, ireference_state, lrho_flucz_as_aux, ldensity_linearstart
!

namelist /density_run_pars/  cdiffrho, diffrho, diffrho_hyper3, diffrho_hyper3_mesh, diffrho_shock,  cs2bot, cs2top, lupw_lnrho, lupw_rho, idiff,  lmass_source, lmass_source_random, diff_cspeed,  mass_source_profile, mass_source_Mdot, mass_source_sigma,  mass_source_offset, rmax_mass_source, lnrho_int, lnrho_ext,  damplnrho_int, damplnrho_ext, wdamp, lfreeze_lnrhoint, lfreeze_lnrhoext,  lnrho_const, lcontinuity_gas, borderlnrho, diffrho_hyper3_aniso,  lfreeze_lnrhosqu, density_floor, lanti_shockdiffusion, lrho_as_aux,  ldiffusion_nolog, lcheck_negative_density,  lmassdiff_fix, lmassdiff_fixmom, lmassdiff_fixkin, lcalc_lnrhomean, ldensity_profile_masscons, lffree, ffree_profile,  rzero_ffree, wffree, tstart_mass_source, tstop_mass_source,  density_xaver_range, mass_source_tau1, reduce_cs2,  lreduced_sound_speed, lrelativistic_eos, ladvection_density,  xblob, yblob, zblob, mass_source_omega, lscale_to_cs2top,  density_zaver_range, rss_coef1, rss_coef2,  ieos_profile, width_eos_prof, beta_glnrho_global, lconserve_total_mass, total_mass, density_ceiling,  lreinitialize_lnrho, lreinitialize_rho, initlnrho, rescale_rho,  lsubtract_init_stratification, ireference_state,  h_sld_dens, lrho_flucz_as_aux, nlf_sld_dens, div_sld_dens,  lSchur_3D3D1D
!
...
integer :: idiag_rhomzmask=0
integer :: idiag_rho2m=0
integer :: idiag_rho4m=0
integer :: idiag_rho6m=0
integer :: idiag_rho12m=0
integer :: idiag_rhof2m=0
integer :: idiag_lnrho2m=0
integer :: idiag_drho2m=0
integer :: idiag_drhom=0
integer :: idiag_rhomin=0
integer :: idiag_rhomax=0
integer :: idiag_lnrhomin=0
integer :: idiag_lnrhomax=0
integer :: idiag_rhorms=0
integer :: idiag_lnrhorms=0
integer :: idiag_ugrhom=0
integer :: idiag_uglnrhom=0
integer :: idiag_lnrhomphi=0
integer :: idiag_rhomphi=0
integer :: idiag_dtd=0
integer :: idiag_dtd3=0
integer :: idiag_rhomr=0
integer :: idiag_totmass=0
integer :: idiag_mass=0
integer :: idiag_sphmass=0
integer :: idiag_inertiaxx=0
integer :: idiag_inertiayy=0
integer :: idiag_inertiazz=0
integer :: idiag_inertiaxx_car=0
integer :: idiag_inertiayy_car=0
integer :: idiag_inertiazz_car=0
integer :: idiag_vol=0
integer :: idiag_grhomax=0
!

! xy averaged diagnostics given in xyaver.in

integer :: idiag_rhomz=0
integer :: idiag_rhoupmz=0
integer :: idiag_rhodownmz=0
integer :: idiag_rho2mz=0
integer :: idiag_rho2upmz=0
integer :: idiag_rho2downmz=0
integer :: idiag_rhof2mz=0
integer :: idiag_rhof2upmz=0
integer :: idiag_rhof2downmz=0
integer :: idiag_gzlnrhomz=0
integer :: idiag_uglnrhomz=0
integer :: idiag_ugrhomz=0
integer :: idiag_uygzlnrhomz=0
integer :: idiag_uzgylnrhomz=0
!

! xz averaged diagnostics given in xzaver.in

integer :: idiag_rhomy=0
!

! yz averaged diagnostics given in yzaver.in

integer :: idiag_rhomx=0
integer :: idiag_rho2mx=0
!

! y averaged diagnostics given in yaver.in

integer :: idiag_rhomxz=0
!

! z averaged diagnostics given in zaver.in

integer :: idiag_rhomxy=0
integer :: idiag_rho2mxy=0
integer :: idiag_sigma=0
!
...
lupw_rho=.true.
if (lroot)  call warning('initialize_density','enabled upwinding for linear density')
elseif (.not.ldensity_nolog.and.lupw_rho) then
lupw_lnrho=.true.
if (lroot)  call warning('initialize_density','enabled upwinding for log density')
endif
!
...
if (.not.ldensity_nolog)  call fatal_error('initialize_density','use of reference state requires use of linear density')
...
if (.not.ltemperature_nolog)  call fatal_error('initialize_density','use of reference state requires use of linear temperature')
endif
endif
endif
!
...
if (lroot.and.ldensity_nolog)  print*,'diffusion: (Dx*d^6/dx^6 + Dy*d^6/dy^6 + Dz*d^6/dz^6)rho'
if (lroot.and..not.ldensity_nolog)  print*,'diffusion: (Dx*d^6/dx^6 + Dy*d^6/dy^6 + Dz*d^6/dz^6)lnrho'
...
case default
write(unit=errormsg,fmt=*) 'initialize_density: ',  'No such value for idiff(',i,'): ', trim(idiff(i))
...
if (lrun) then
if ((ldiff_normal.or.ldiff_cspeed).and.diffrho==0.0)  call warning('initialize_density',  'Diffusion coefficient diffrho is zero!', 0)
if (ldiff_cspeed.and..not.(lentropy.or.ltemperature))  call warning('initialize_density',  'Diffusion with cspeed can only be used with lenergy!', 0)
if ( (ldiff_hyper3 .or. ldiff_hyper3lnrho .or. ldiff_hyper3_strict .or.  ldiff_hyper3lnrho_strict) .and. diffrho_hyper3==0.0)  call fatal_error('initialize_density',  'Diffusion coefficient diffrho_hyper3 is zero!')
if ( (ldiff_hyper3_aniso) .and.   ((diffrho_hyper3_aniso(1)==0. .and. nxgrid/=1 ).or.  (diffrho_hyper3_aniso(2)==0. .and. nygrid/=1 ).or.  (diffrho_hyper3_aniso(3)==0. .and. nzgrid/=1 )) )  call fatal_error('initialize_density',  'A diffusion coefficient of diffrho_hyper3 is zero!')
if (ldiff_shock .and. diffrho_shock==0.0)  call fatal_error('initialize_density',  'diffusion coefficient diffrho_shock is zero!')
if (ldiff_normal.or.ldiff_cspeed.or.ldiff_shock) then
call warning('initialize_density',  'For diffusion energy/momentum correction should use lmassdiff_fix!', 0)
endif
if (lmassdiff_fixkin.or.lmassdiff_fixmom) then
lmassdiff_fix=.true.
call warning('initialize_density',  'Deprecated: lmassdiff_fix now the default!', 0)
endif
!
...
call fatal_error("initialize_density", "Dynamical diffusion requires mesh hyper-diffusion, switch idiff='hyper3-mesh'")
endif
!
...
if (lrho_as_aux) then
if (ldensity_nolog) then
if (lroot) print*, 'initialize_density: makes no sense to have '//  'lrho_as_aux=T if already evolving non log rho'
call fatal_error('initialize_density','')
else
...
dprofz_ffree=0.
case default
call fatal_error('initialize_density',  'you have chosen lffree=T but did not select a profile!')
endselect
!
...
case ('sph-step-down')
if (.not.lspherical_coords) call fatal_error('initialize_density',  'you have chosen mass-source profiles "sph-step-down", but coordinate system is not spherical!')
...
case default
call fatal_error('initialize_density',  'type of reference state "'//trim(ireference_state)//'" not implemented')
end select
!
...
if (lread_oldsnap .and. ldensity_nolog .and. .not. all(initlnrho == 'nothing'))  call fatal_error('init_lnrho', 'cannot add initial conditions to the old snapshot. ')
!
...
elseif ( any(initlnrho=='piecew-poly') .or. any(initlnrho=='piecew-disc') .or. any(initlnrho=='polytropic') .or.  any(initlnrho(:)(1:1)=='4') .or. any(initlnrho=='5') ) then
...
enddo
case ('x-point_xy')
f(:,:,:,ilnrho)=f(:,:,:,ilnrho)-.5*ampllnrho(j)/cs20*(  spread(spread(x**2,2,my),3,mz)  +spread(spread(y**2,1,mx),3,mz) )
case ('mode')
...
call blob(ampllnrho(j)/(sqrt2pi*radius_lnrho(j))**3,f,ilnrho,  radius_lnrho(j)*sqrt2,xblob(j),yblob(j),zblob(j))
case ('blob_hs')
print*, 'init_lnrho: put a blob in hydrostatic equilibrium:'//  'radius_lnrho, ampllnrho, position=',radius_lnrho(j),  ampllnrho(j), xblob(j), yblob(j), zblob(j)
call blob(ampllnrho(j),f,ilnrho,radius_lnrho(j),xblob(j),yblob(j),zblob(j))
call blob(-ampllnrho(j),f,iss,radius_lnrho(j),xblob(j),yblob(j),zblob(j))
case ('pre-stellar'); call pre_stellar_cloud(f, datafile, mass_cloud,  cloud_mode, T_cloud_out_rel,  dens_coeff, temp_coeff, temp_trans, temp_coeff_out)
...
f(l1:l2,m,n,ilnrho) = f(l1:l2,m,n,ilnrho) +  alog(1+amplrho(j)*sin(kx_lnrho(j)*x(l1:l2)+  ky_lnrho(j)*y(m)+kz_lnrho(j)*z(n)+phase_lnrho(j)))
enddo; enddo
case ('coswave-phase')
...
case ('triquad')
call triquad(ampllnrho(j),f,ilnrho,kx_lnrho(j),  ky_lnrho(j),kz_lnrho(j), kxx_lnrho(j), kyy_lnrho(j),  kzz_lnrho(j))
case ('isotdisk')
...
case ('gauss-z-offset')
do n=n1,n2
f(:,:,n,ilnrho) = f(:,:,n,ilnrho) +  alog(exp(f(:,:,n,ilnrho))+  ampllnrho(j)*(exp(-(z(n)+lnrho_z_shift)**2/  (2*radius_lnrho(j)**2))))
enddo
case ('gaussian-noise')
...
call gaunoise(ampllnrho(j),f,ilnrho,ilnrho)
f(:,:,:,ilnrho)=spread(spread(f(:,4,4,ilnrho),2,my),3,mz)
!
...
do n=n1,n2; do m=m1,m2
f(l1:l2,m,n,ilnrho) = -grads0*z(n)  + 1./gamma_m1*log( 1 + gamma_m1*gravz/grads0/cs20  *(1-exp(-grads0*z(n))) )
enddo; enddo
endif
...
do n=n1,n2; do m=m1,m2
f(l1:l2,m,n,ilnrho)=log(rho0*(1+  ampllnrho(j)*sin((kx_lnrho(j)*x(l1:l2))+ky_lnrho(j)*y(m))  *(1+ampllnrho(j)*sin(kz_lnrho(j)*z(n)))))
enddo; enddo
case ('linear')
!
...
do n=n1,n2; do m=m1,m2
f(l1:l2,m,n,ilnrho) = log(rho0) +  ampllnrho(j)*(kx_lnrho(j)*x(l1:l2)+  ky_lnrho(j)*y(m)+kz_lnrho(j)*z(n))/  sqrt(kx_lnrho(j)**2+ky_lnrho(j)**2+kz_lnrho(j)**2)
enddo; enddo
case ('planet')
!
...
case ('thermal-hs')
if (lroot) call information('init_lnrho',  'thermal hydrostatic equilibrium setup done in interstellar')
case ('geo-kws')
!
...
if (lroot)  print*,'Re(omega_jeans), Im(omega_jeans), Abs(omega_jeans)', real(omega_jeans),aimag(omega_jeans),abs(omega_jeans)
!

do n=n1,n2; do m=m1,m2
f(l1:l2,m,n,ilnrho) = lnrho_const +  ampllnrho(j)*sin(kx_lnrho(j)*x(l1:l2)+phase_lnrho(j))
if (abs(omega_jeans)/=0.0) then
f(l1:l2,m,n,iux) = f(l1:l2,m,n,iux) +  abs(omega_jeans*ampllnrho(j)) *  sin(kx_lnrho(j)*x(l1:l2)+phase_lnrho(j)+  complex_phase(omega_jeans*ampllnrho(j)))
else
...
print*,'Re(omega_jeans), Im(omega_jeans), Abs(omega_jeans)', real(omega_jeans),aimag(omega_jeans),abs(omega_jeans)
!

do n=n1,n2; do m=m1,m2
f(l1:l2,m,n,ilnrho) = lnrho_const +  ampllnrho(j)*sin(kx_lnrho(j)*x(l1:l2) +  ky_lnrho(j)*y(m) + kz_lnrho(j)*z(n))
if (kx_lnrho(j)/=0)  f(l1:l2,m,n,iux) = f(l1:l2,m,n,iux) +  abs(omega_jeans*ampllnrho(j)) *  sin(kx_lnrho(j)*x(l1:l2)+complex_phase(omega_jeans*ampllnrho(j)))
if (ky_lnrho(j)/=0)  f(l1:l2,m,n,iuy) = f(l1:l2,m,n,iuy) +  abs(omega_jeans*ampllnrho(j)) *  sin(ky_lnrho(j)*y(m)+complex_phase(omega_jeans*ampllnrho(j)))
if (kz_lnrho(j)/=0)  f(l1:l2,m,n,iuz) = f(l1:l2,m,n,iuz) +  abs(omega_jeans*ampllnrho(j)) *  sin(kz_lnrho(j)*z(n)+complex_phase(omega_jeans*ampllnrho(j)))
enddo; enddo
!
...
call get_shared_variable('rhs_poisson_const', rhs_poisson_const,  caller='init_lnrho')
omega_jeans = sqrt(cmplx(cs20*kx_lnrho(j)**2 +  Omega**2 - rhs_poisson_const*rho0,0.))/(rho0*kx_lnrho(j))
!
...
do n=n1,n2; do m=m1,m2
f(l1:l2,m,n,ilnrho) = lnrho_const +  ampllnrho(j)*sin(kx_lnrho(j)*x(l1:l2))
f(l1:l2,m,n,iux) = f(l1:l2,m,n,iux) +  abs(omega_jeans*ampllnrho(j)) *  sin(kx_lnrho(j)*x(l1:l2)+complex_phase(omega_jeans*ampllnrho(j)))
f(l1:l2,m,n,iuy) = f(l1:l2,m,n,iuy) +  abs(ampllnrho(j)*  cmplx(0,-0.5*Omega/(kx_lnrho(j)*rho0))) *  sin(kx_lnrho(j)*x(l1:l2)+complex_phase(ampllnrho(j)*  cmplx(0,-0.5*Omega/(kx_lnrho(j)*rho0))))
enddo; enddo
!
...
write(unit=errormsg,fmt=*) 'No such value for initlnrho('  //trim(iinit_str)//'): ',trim(initlnrho(j))
...
if (ldensity_nolog .and. (.not.lread_oldsnap) .and. (.not.ldensity_linearstart))  f(:,:,:,irho)=exp(f(:,:,:,ilnrho))
...
if ( (.not.ldensity_nolog) .and. (irho/=0) )  f(l1:l2,m1:m2,n1:n2,irho)=exp(f(l1:l2,m1:m2,n1:n2,ilnrho))
!
...
call fatal_error_local('polytropic_lnrho_z',  'Imaginary density values -- your z_inf is too low.')
endif
tmp = max(tmp,epsi)
...
if ( (tmp<=0.0) .and. (z(n)<=zblend) ) then
call fatal_error_local('polytropic_lnrho_disc',  'Imaginary density values -- your z_inf is too low.')
endif
tmp = max(tmp,epsi)
tmp = lnrhoint + mpoly*log(tmp)
endif
...
beta1=g0/(mpoly+1)*gamma/gamma_m1
!
...
if (ldensity_nolog)  call fatal_error('numerical_equilibrium','not implemented for linear density')
!
...
if (lmass_source) then
if ((mass_source_profile=='bump').or.(mass_source_profile=='sph-step-down'))  lpenc_requested(i_r_mn)=.true.
...
if (idiag_rhom/=0 .or. idiag_rho2m/=0 .or.idiag_rho4m/=0 .or.idiag_rho6m/=0 .or.  idiag_rho12m/=0 .or. idiag_rhof2m/=0 .or. idiag_rhomy/=0 .or.  idiag_rhomx/=0 .or. idiag_rho2mx/=0 .or. idiag_rhomz/=0 .or. idiag_rho2mz/=0 .or.  idiag_rhomin/=0 .or.  idiag_rhomax/=0 .or. idiag_rhomxz/=0 .or.  idiag_totmass/=0 .or. idiag_mass/=0 .or. idiag_drho2m/=0 .or. idiag_rhorms/=0 .or.  idiag_inertiaxx/=0 .or. idiag_inertiayy/=0 .or. idiag_inertiazz/=0 .or.  idiag_inertiaxx_car/=0 .or. idiag_inertiayy_car/=0 .or. idiag_inertiazz_car/=0 .or.  idiag_drhom/=0 .or. idiag_rhomxmask/=0 .or. idiag_sigma/=0 .or. idiag_rhomzmask/=0 .or.  idiag_rhoupmz/=0 .or. idiag_rhodownmz/=0 .or. idiag_rho2upmz/=0 .or.  idiag_rho2downmz/=0 .or. idiag_rhof2mz/=0 .or. idiag_rhof2upmz/=0 .or.  idiag_rhof2downmz/=0 .or. idiag_sphmass/=0)  lpenc_diagnos(i_rho)=.true.
...
if (idiag_rhoupmz/=0 .or. idiag_rhodownmz/=0 .or. idiag_rho2upmz/=0 .or.  idiag_rho2downmz/=0 .or. idiag_rhof2upmz/=0 .or. idiag_rhof2downmz/=0)  lpenc_diagnos(i_uu)=.true.
...
if (idiag_inertiaxx_car/=0 .or. idiag_inertiayy_car/=0 .or.  idiag_inertiazz_car/=0 .or. idiag_sphmass/=0) lpenc_diagnos(i_r_mn)=.true.
!
...
if (lpenc_loc(i_rhos1))  call fatal_error('calc_pencils_density_pnc', 'rhos1 is no implemented')
if (lpenc_loc(i_glnrhos))  call fatal_error('calc_pencils_density_pnc', 'glnrhos is no implemented')
!
...
if (lpenc_loc(i_uglnrho)) call fatal_error('calc_pencils_density',  'uglnrho not available for linear mass density')
! ugrho
...
call fatal_error('calc_pencils_density',  'del6lnrho not available for linear mass density')
elseif (ldiff_hyper3lnrho_strict) then
call fatal_error('calc_pencils_density',  'del6lnrho_strict not available for linear mass density')
endif
endif
! hlnrho

if (lpenc_loc(i_hlnrho)) call fatal_error('calc_pencils_density',  'hlnrho not available for linear mass density')
! sglnrho
...
if (lreference_state) then
call weno_transp(f,m,n,irho,-1,iux,iuy,iuz,p%transprho,dx_1,dy_1,dz_1,  reference_state(:,iref_rho))
else
...
if (lpenc_loc(i_ugrho)) call fatal_error('calc_pencils_density',  'ugrho not available for logarithmic mass density')
! glnrho2

if (lpenc_loc(i_glnrho2)) call dot2(p%glnrho,p%glnrho2)
! del2rho

if (lpenc_loc(i_del2rho)) call fatal_error('calc_pencils_density',  'del2rho not available for logarithmic mass density')
! del2lnrho

if (lpenc_loc(i_del2lnrho)) call del2(f,ilnrho,p%del2lnrho)
! del6rho

if (lpenc_loc(i_del6rho)) call fatal_error('calc_pencils_density',  'del6rho not available for logarithmic mass density')
! del6lnrho
...
if (lSchur_3D3D1D) then
df(l1:l2,m,n,ilnrho)=df(l1:l2,m,n,ilnrho)  +Schur_dlnrho_RHS_xyzaver  -Schur_dlnrho_RHS_xyaver_z(n)  -Schur_dlnrho_RHS_zaver_xy(l1:l2,m)
else
!
...
if (lcontinuity_gas) then
if (.not. lweno_transport .and.  .not. lffree .and. .not. lreduced_sound_speed .and.  ieos_profile=='nothing' .and. .not. lfargo_advection) then
!
...
if (ldensity_profile_masscons)  density_rhs=density_rhs - p%rho*(  dprofx_ffree   *p%uu(:,1)  + dprofy_ffree(m)*p%uu(:,2)  + dprofz_ffree(n)*p%uu(:,3))
else
density_rhs= density_rhs - profx_ffree*(profy_ffree(m)*profz_ffree(n))  *(p%uglnrho + p%divu)
if (ldensity_profile_masscons)  density_rhs=density_rhs -dprofx_ffree   *p%uu(:,1)  -dprofy_ffree(m)*p%uu(:,2)  -dprofz_ffree(n)*p%uu(:,3)
endif
endif
!
...
if (lanti_shockdiffusion) then
fdiff = fdiff - diffrho_shock * (  p%shock*(del2lnrho_glnrho2_init_z(n) +  2*(p%glnrho(:,3)-dlnrhodz_init_z(n))*dlnrhodz_init_z(n)) +  p%gshock(:,3)*dlnrhodz_init_z(n) )
endif
endif
endif
...
if (ldt_up) diffus_diffrho3=diffus_diffrho3+  (diffrho_hyper3_aniso(1)*dline_1(:,1)**6 +  diffrho_hyper3_aniso(2)*dline_1(:,2)**6 +  diffrho_hyper3_aniso(3)*dline_1(:,3)**6)/dxyz_6
...
if (headtt .and. ldiff_hyper3lnrho_strict ) print*,  'dlnrho_dt: diffrho_hyper3_strict=', diffrho_hyper3
endif
!
...
if (l1davgfirst) then
if ((idiag_rhof2mz/=0 .or. idiag_rhof2upmz/=0 .or. idiag_rhof2downmz/=0)  .and..not. lrho_flucz_as_aux) then
call stop_it('calc_1d_diagnostics_density: Need to set lrho_flucz_as_aux=T'//  ' in density_run_pars for density fluctuation diagnostics.')
endif
!
...
if (idiag_inertiaxx_car/=0 .or. idiag_inertiayy_car/=0 .or.  idiag_inertiazz_car/=0 .or. idiag_sphmass/=0) then
where (p%r_mn <= 1.)
rmask = 1.
elsewhere
rmask = 0.
...
case ('nothing')
if (lroot.and.ip<=5)  print*,"set_border_density: borderlnrho='nothing'"
!

case default
write(unit=errormsg,fmt=*)  'set_border_density: No such value for borderlnrho: ',  trim(borderlnrho)
...
if (gamma/=1.0) then
if ((.not. lentropy) .and. (.not. ltemperature))  call fatal_error('isothermal_density',  'for gamma/=1.0, you need entropy or temperature!');
endif
!
...
if (lentropy.and..not.pretend_lnTT) then
f(l1:l2,m,n,iss) = f(l1:l2,m,n,iss) +  (1/cp1)*(f(l1:l2,m,n,ilnrho)-lnrho0)*(ggamma/gamma-1.)
elseif (lentropy.and.pretend_lnTT) then
call fatal_error("stratification_tsallis",  "not implemented for pretend_lnTT")
elseif (ltemperature.and..not.ltemperature_nolog) then
call fatal_error("stratification_tsallis",  "not implemented for ltemperature")
elseif (ltemperature.and.ltemperature_nolog) then
call fatal_error("stratification_tsallis",  "not implemented for ltemperature_nolog")
endif
enddo
enddo
!
...
pdamp=1.-step(p%rcyl_mn,r_int,wdamp)
...
pdamp=step(p%rcyl_mn,r_ext,wdamp)
...
if (lfullvar_in_slices)  call addto_slices(slices,reference_state(:,iref_rho))
!
