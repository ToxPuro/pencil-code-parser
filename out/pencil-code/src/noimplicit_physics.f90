...
module procedure heatcond_TT_0d
module procedure heatcond_TT_1d
module procedure heatcond_TT_2d
end interface
!
...
print*,'Tbump, Kmax, Kmin, hole_slope, hole_width, hole_alpha=',  Tbump, Kmax, Kmin, hole_slope, hole_width, hole_alpha
print*, '*****************************************'
endif
!
