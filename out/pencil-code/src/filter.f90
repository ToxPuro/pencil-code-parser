...
write(*,'(" ",A,I2," -",I2,A,G12.5)')  'rmwig: removing wiggles in variable ', ivar1,ivar2, ', t=', t
endif
!
...
call boundconds_x(f)
call rmwig_1d(f,df,ivar1,ivar2,awigg,1)
call boundconds_y(f)
call rmwig_1d(f,df,ivar1,ivar2,awigg,2)
call boundconds_z(f)
call rmwig_1d(f,df,ivar1,ivar2,awigg,3)
!
...
do ivar=ivar1,ivar2
f(l1:l2,m1:m2,n1:n2,ivar) =  f(l1:l2,m1:m2,n1:n2,ivar) + awigg*df(l1:l2,m1:m2,n1:n2,ivar)
enddo
!
...
write(*,'(" ",A,I2,A,G12.5)')  'rmwig_old: removing wiggles in variable', ivar, ', t=', t
endif
endif
!
...
f(l1:l2,m1:m2,n1:n2,ivar) =  f(l1:l2,m1:m2,n1:n2,ivar) + df(l1:l2,m1:m2,n1:n2,ivar)
!
...
write(*,'(" ",A,I3,A,G12.5)')  'rmwig_xyaverage: removing wiggles in xyaverage of variable ', ivar, 't=', t
endif
endif
!
...
write(*,'(" ",A,I3,A,G12.5)')  'rmwig_lnxyaverage: removing wiggles in xyaverage of variable ', ivar, 't=', t
endif
endif
!
