...
real, dimension(mcom) :: fbcx1=0., fbcx2=0., fbcx1_2=0., fbcx2_2=0.,  fbcy1=0., fbcy2=0., fbcy1_1=0., fbcy1_2=0., fbcy2_1=0., fbcy2_2=0.,  fbcz1=0., fbcz2=0., fbcz1_1=0., fbcz1_2=0., fbcz2_1=0., fbcz2_2=0.
integer :: niter_poisson
! 

namelist /init_pars/  cvsid, ip, xyz0, xyz1, Lxyz, lperi, lshift_origin, lshift_origin_lower, xyz_units, wav1, wav1z, coord_system, lpole, ncoarse, lfix_unit_std,  lequidist, coeff_grid, zeta_grid0, grid_func, xyz_star, lwrite_ic, lwrite_avg1d_binary,  lnowrite, luniform_z_mesh_aspect_ratio, unit_system, unit_length,  lmodify,modify_filename, dvid, ldivu_perp,  unit_velocity, unit_density, unit_temperature, unit_magnetic, c_light,  G_Newton, hbar, random_gen, seed0, lseed_global, lseed_procdependent, nfilter, lserial_io, der2_type,  lread_oldsnap, lwrite_var_anyway, lwrite_last_powersnap,  lread_oldsnap_nomag, lread_oldsnap_nopscalar, lread_oldsnap_notestflow, lread_oldsnap_noisothmhd,  lread_oldsnap_notestfield, lread_oldsnap_notestscalar, lread_oldsnap_noshear,  lread_oldsnap_nohydro, lread_oldsnap_nohydro_nomu5,  lread_oldsnap_nohydro_efield, lread_oldsnap_nohydro_ekfield,  lread_oldsnap_onlyA,  ireset_tstart, tstart, lghostfold_usebspline,  lread_aux, lwrite_aux, lkinflow_as_aux, lenforce_maux_check,  lreport_undefined_diagnostics, pretend_lnTT, lprocz_slowest, lzorder,  lcopysnapshots_exp, bcx, bcy, bcz, r_int, r_ext, r_ref, rsmooth,  r_int_border, r_ext_border, mu0, force_lower_bound, force_upper_bound,  lseparate_persist, ldistribute_persist, lpersist, lomit_add_data,  fbcx1, fbcx2, fbcx1_2, fbcx2_2,  fbcy1, fbcy2, fbcy1_1, fbcy1_2, fbcy2_1, fbcy2_2,  fbcz1, fbcz2, fbcz1_1, fbcz1_2, fbcz2_1, fbcz2_2,  fbcx_bot, fbcx_top, fbcy_bot, fbcy_top, fbcz_bot, fbcz_top, bc_slc_dir,  vel_spec, mag_spec,  uxy_spec, bxy_spec, jxbxy_spec, xy_spec, oo_spec,  uxj_spec, vec_spec, ou_spec, oun_spec, ab_spec, azbz_spec, uzs_spec, ub_spec,  bb2_spec, jj2_spec, ele_spec, a0_spec, pot_spec,  Lor_spec, EMF_spec, Tra_spec, GWs_spec, GWh_spec, GWm_spec, Str_spec, Stg_spec,  GWs_spec_boost, GWh_spec_boost,  SCL_spec, VCT_spec, Tpq_spec, TGW_spec, GWd_spec, GWe_spec, GWf_spec, GWg_spec,  SCL_spec_boost, VCT_spec_boost,  StT_spec, StX_spec,  vel_phispec, mag_phispec,  uxj_phispec, vec_phispec, ou_phispec, ab_phispec, EP_spec, ro_spec,  nd_spec, ud_spec, ux_spec, uy_spec, uz_spec, ucp_spec,  TT_spec, ss_spec, cc_spec, cr_spec, mu_spec, sp_spec, ssp_spec, sssp_spec,  isaveglobal, lr_spec, r2u_spec,  np_spec, np_ap_spec, rhop_spec,  r3u_spec, rhocc_pdf, cc_pdf, lncc_pdf, gcc_pdf, lngcc_pdf,  xyz_step, xi_step_frac, xi_step_width, dxi_fact, trans_width,  lcylinder_in_a_box, lsphere_in_a_box, llocal_iso, init_loops, lwrite_2d,  lcylindrical_gravity,  border_frac_x, border_frac_y, border_frac_z, lborder_hyper_diff,  luse_latitude, lshift_datacube_x, lfargo_advection, yequator, lequatory,  lequatorz, zequator, lav_smallx, xav_max, niter_poisson,  lforce_shear_bc,lread_from_other_prec,  pipe_func, glnCrossSec0, CrossSec_x1, CrossSec_x2, CrossSec_w, lcorotational_frame, rcorot, lproper_averages,  ldirect_access, ltolerate_namelist_errors,  lyinyang, cyinyang_intpol_type, yy_biquad_weights,  lcutoff_corners, nycut, nzcut, rel_dang,  sigmaSB_set, c_light_set, cp_set, k_B_set, m_u_set,  lnoghost_strati, ichannel1, ichannel2, tag_foreign,  lpoint, mpoint, npoint, lpoint2, mpoint2, npoint2,  lfatal_num_vector_369, density_scale_factor
!

namelist /run_pars/  cvsid, ip, xyz0, xyz1, Lxyz, lperi, lpole, ncoarse,  lshift_origin, lshift_origin_lower, coord_system,  nt, it1, it1start, it1d, it_rmv, dt, cdt, ddt, dt_incr,  lfractional_tstep_advance, lfractional_tstep_negative,  cdtv, cdtv2, cdtv3, cdtsrc, cdts, cdtr,  cdtc, isave, itorder, dsnap, dsnap_down, mvar_down, maux_down,  d1davg, d2davg, dvid, dsound, dtmin, dspec, tmax, toutoff,  iwig, ldivu_perp,  dtracers, dfixed_points, unit_system, unit_length,  unit_velocity, unit_density, unit_temperature, unit_magnetic,  awig, ialive, max_walltime, dtmax, ldt_paronly,  lspec_start, lspec_at_tplusdt, vel_spec, mag_spec,  uxy_spec, bxy_spec, jxbxy_spec, xy_spec, oo_spec,  uxj_spec, vec_spec, ou_spec, oun_spec, ab_spec, azbz_spec, uzs_spec, ub_spec,  bb2_spec, jj2_spec, ele_spec, a0_spec, pot_spec,  Lor_spec, EMF_spec, Tra_spec, GWs_spec, GWh_spec, GWm_spec, Str_spec, Stg_spec,  GWs_spec_boost, GWh_spec_boost,  SCL_spec, VCT_spec, Tpq_spec, TGW_spec, GWd_spec, GWe_spec, GWf_spec, GWg_spec,  SCL_spec_boost, VCT_spec_boost,  StT_spec, StX_spec,  vel_phispec, mag_phispec,  uxj_phispec, vec_phispec, ou_phispec, ab_phispec, EP_spec, ro_spec,  nd_spec, ud_spec, ux_spec, uy_spec, uz_spec, ucp_spec,  TT_spec, ss_spec, cc_spec, cr_spec, mu_spec, sp_spec, ssp_spec, sssp_spec,  isaveglobal, lr_spec, r2u_spec,  np_spec, np_ap_spec, rhop_spec,  r3u_spec, rhocc_pdf, cc_pdf, lncc_pdf, gcc_pdf, lngcc_pdf,  lnspecial_pdf, special_pdf, ang_jb_pdf1d, ang_ub_pdf1d, ang_ou_pdf1d,  kinflow, ladv_der_as_aux, lkinflow_as_aux,  ampl_kinflow_x, ampl_kinflow_y, ampl_kinflow_z,  kx_kinflow, ky_kinflow, kz_kinflow, dtphase_kinflow,  random_gen, der2_type, lrmwig_rho, lrmwig_full, lrmwig_xyaverage,  lnowrite, noghost_for_isave, nghost_read_fewer,  test_nonblocking, lwrite_tracers, lwrite_fsum, lwrite_fixed_points, lwrite_ts_hdf5,  lread_oldsnap_lnrho2rho, lread_oldsnap_nomag, lread_oldsnap_notestflow, lread_oldsnap_nopscalar,  lread_oldsnap_notestfield, lread_oldsnap_notestscalar, lread_oldsnap_noshear, lrepair_snap, linterpol_on_repair,  lread_oldsnap_nohydro, lread_oldsnap_nohydro_efield, lread_oldsnap_nohydro_ekfield,  lread_oldsnap_noisothmhd, lread_oldsnap_onlyA,  lread_oldsnap_rho2lnrho, lread_oldsnap_nosink, lwrite_dim_again, lwrite_last_powersnap,  lread_aux, comment_char, ix, iy, iy2, iz, iz2, iz3, iz4, slice_position,  xbot_slice, xtop_slice, ybot_slice, ytop_slice, zbot_slice, ztop_slice,  r_rslice, nth_rslice, nph_rslice,  bcx, bcy, bcz, r_int, r_ext, r_int_border,  r_ext_border, lfreeze_varsquare, lfreeze_varint, lfreeze_varext,  xfreeze_square, yfreeze_square, rfreeze_int, rfreeze_ext, wfreeze,  wfreeze_int, wfreeze_ext, wborder, wborder_int, wborder_ext, tborder,  luse_oldgrid, luse_xyz1, fshift_int, fshift_ext, lpersist,  ireset_tstart, tstart, lseparate_persist, ldistribute_persist, lomit_add_data,  fbcx1, fbcx2, fbcx1_2, fbcx2_2,  fbcy1, fbcy2, fbcy1_1, fbcy1_2, fbcy2_1, fbcy2_2,  fbcz1, fbcz2, fbcz1_1, fbcz1_2, fbcz2_1, fbcz2_2,  fbcx_bot, fbcx_top, fbcy_bot, fbcy_top, fbcz_bot, fbcz_top,  Udrift_bc, ttransient, tavg, idx_tavg, lserial_io, nr_directions,  lsfu, lsfb, lsfz1, lsfz2, lsfflux, lpdfu, lpdfb, lpdfz1, lpdfz2, onedall,  lreport_undefined_diagnostics, pretend_lnTT, old_cdtv, lmaxadvec_sum, save_lastsnap,  lwrite_aux, lwrite_dvar, force_lower_bound, force_upper_bound,  lenforce_maux_check, nv1_capitalvar, mskipvar, lread_oldsnap_mskipvar,  oned, twod, lpoint, mpoint, npoint, lpoint2, mpoint2, npoint2,  iproc_pt, iproc_p2,  border_frac_x, border_frac_y, border_frac_z, lborder_hyper_diff,  lcylinder_in_a_box, lsphere_in_a_box, ipencil_swap,  lpencil_requested_swap, lpencil_diagnos_swap, lpencil_check,  lpencil_check_small, lpencil_check_no_zeros, lpencil_check_diagnos_opti,  lpencil_init, penc0, lwrite_2d, lbidiagonal_derij, lisotropic_advection,  crash_file_dtmin_factor, ltestperturb, eps_rkf,  eps_stiff, timestep_scaling, lequatory, lequatorz, zequator,  lini_t_eq_zero, lini_t_eq_zero_once,  lav_smallx, xav_max, ldt_paronly, lweno_transport,  it_timing, har_spec, hav_spec, j_spec, jb_spec, ja_spec, b2_spec,  lread_less, lread_nogrid, lformat, ltec,  llsode, lsplit_second, nu_sts, permute_sts, lfargo_advection,  ldynamical_diffusion, ldyndiff_useumax, re_mesh, lghostfold_usebspline,  lreset_seed, loutput_varn_at_exact_tsnap, lstop_on_ioerror, mailaddress, mailcmd, submithost, theta_lower_border, wborder_theta_lower, theta_upper_border,  wborder_theta_upper, fraction_tborder, lmeridional_border_drive,  lread_from_other_prec, downsampl, lfullvar_in_slices, ivar_omit,  lsubstract_reference_state, lzaver_on_input,  ldirect_access, lproper_averages, lmaximal_cdt, lmaximal_cdtv,  pipe_func, glnCrossSec0, CrossSec_x1, CrossSec_x2, CrossSec_w,  cyinyang_intpol_type, yy_biquad_weights, lcutoff_corners, nycut, nzcut, rel_dang,  lignore_nonequi, tag_foreign, tau_aver1, fmt_avgs,  ou_omega, ou_kzspec, ab_kzspec, cor_uu, ou_polar, ab_polar, jb_polar,  uut_spec, uut_polar, ouout_spec, ouout2_spec, ouout_polar, out_spec, uot_spec,  saffman_ub, saffman_mag, saffman_mag_c, saffman_aa, saffman_aa_c, saffman_bb,  uu_fft3d, oo_fft3d, bb_fft3d, jj_fft3d, uu_xkyz, oo_xkyz, bb_xkyz, jj_xkyz,  uu_kx0z, oo_kx0z, bb_kx0z, jj_kx0z, bb_k00z, ee_k00z, gwT_fft3d,  Em_specflux, Hm_specflux, Hc_specflux, density_scale_factor
!

namelist /IO_pars/  lcollective_IO, IO_strategy
!
...
if (lroot) call warning('read_all_init_pars',  'obsolete old_cdtv now replaced by more general lmaximal_cdtv')
endif
!
...
print*, 'get_downpars: Warning - stepsize for downsampling in '//  coornames(ind)//'-direction ', downsampl(ind), 'greater than grid size ', n,  '! Set to grid size.'
downsampl(ind)=n
endif
!
...
call write_stub ('streamlines', ltracers)
...
if (file_exists('data/param2.nml'))  call system_cmd("sed -e's/[eE]+*000*//g' -e's/ *, *$//' < data/param2.nml > data/param2.nml.sv")
