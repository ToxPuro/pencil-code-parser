...
call fatal_error('fourier_transform',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fourier_transform_xy',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fourier_transform_xz',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fourier_transform_x',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fourier_transform_y',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fourier_transform_shear',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fourier_transform_shear_xy',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fourier_transform_other_1',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fourier_transform_other_2',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fourier_transform_xy_xy',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fft_x_parallel_1D',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fft_x_parallel_2D',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fft_x_parallel_3D',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fft_x_parallel_4D',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fft_y_parallel_1D',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fft_y_parallel_2D',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fft_y_parallel_3D',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fft_y_parallel_4D',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fft_z_parallel_1D',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fft_z_parallel_2D',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fft_z_parallel_3D',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fft_z_parallel_4D',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fft_xy_parallel_2D',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fft_xy_parallel_2D_other',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fft_xy_parallel_3D',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fft_xy_parallel_4D',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fft_xyz_parallel_3D',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fft_xyz_parallel_4D',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('setup_extrapol_fact',  'this sub is not available in nofourier.f90!', lfirst_proc_xy)
!
...
call fatal_error('vect_pot_extrapol_z_parallel',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('field_extrapol_z_parallel',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fourier_transform_y_y',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fourier_shift_yz_y',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fourier_shift_y',  'this sub is not available in nofourier.f90!')
!
...
call fatal_error('fourier_transform_real_1',  'this sub is not available in nofourier.f90!')
!
