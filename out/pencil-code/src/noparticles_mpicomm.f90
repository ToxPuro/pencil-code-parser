...
print*, 'dist_particles_evenly_procs: npar_species '//  'must be a whole multiple of npar!'
...
print*, 'dist_particles_evenly_procs: npar_per_species   =',  npar_per_species
print*, 'dist_particles_evenly_procs: ipar_fence_species =',  ipar_fence_species
!
