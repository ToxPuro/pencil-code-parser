...
integer, parameter :: ikind8=selected_int_kind(14)
integer, parameter :: ikind4=selected_int_kind(9)
integer, parameter :: ikind1=selected_int_kind(2)
integer, parameter :: rkind8=selected_real_kind(12)
...
integer(KIND=ikind8), parameter :: nwgrid=int(nxgrid,kind=ikind8)*  int(nygrid,kind=ikind8)*  int(nzgrid,kind=ikind8)
!
...
real, parameter :: max_real=huge_real/10.
!
...
double precision, parameter :: hbar_cgs=1.054571596d-27
double precision, parameter :: k_B_cgs=1.3806505d-16
double precision, parameter :: m_u_cgs=1.66053886d-24
double precision, parameter :: mu0_cgs=4*pi
double precision, parameter :: R_cgs=8.3144D7
double precision, parameter :: m_p_cgs=1.67262158d-24
double precision, parameter :: m_e_cgs=9.10938188d-28
double precision, parameter :: m_H_cgs=m_e_cgs+m_p_cgs
double precision, parameter :: eV_cgs=1.602176462d-12
double precision, parameter :: sigmaSB_cgs=5.670400d-5
! unclear source (probably just guessing?)

double precision, parameter :: sigmaH_cgs=4.d-17
double precision, parameter :: kappa_es_cgs=3.4d-1
double precision, parameter :: c_light_cgs=2.99792458d10
double precision, parameter :: G_Newton_cgs=6.6742d-8
double precision, parameter :: density_scale_cgs=2.7774d21
!
