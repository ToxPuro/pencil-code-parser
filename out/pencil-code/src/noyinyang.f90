...
if (lroot)  print*, 'bilin_interp: not implemented in Fortran 95'
stop
buffer=0.
...
integer :: nok
nok=0
if (lroot)  print*, 'prep_interp: not implemented in Fortran 95'
stop
indcoeffs%inds=0
indcoeffs%coeffs=0.
...
if (lroot)  print*, 'coeffs_to_weights: not implemented in Fortran 95'
stop
