...
real, dimension(nx) :: xmask_hyd, cx10, sx10
...
namelist /hydro_run_pars/  Omega, theta, tdamp, dampu, dampuext, dampuint, rdampext, rdampint,  wdamp, tau_damp_ruxm, tau_damp_ruym, tau_damp_ruzm, tau_diffrot1,  inituu, ampluu, kz_uu, ampl1_diffrot, ampl2_diffrot, uuprof,  xexp_diffrot, kx_diffrot, kz_diffrot, kz_analysis, phase_diffrot, ampl_wind,  lreinitialize_uu, lremove_mean_momenta, lremove_mean_flow, lremove_uumeanx, lremove_uumeany,lremove_uumeanxy,lremove_uumeanz,lremove_uumeanz_horizontal,  ldamp_fade, tfade_start, lOmega_int, Omega_int, lupw_uu, othresh,  othresh_per_orms, borderuu, lfreeze_uint, lpressuregradient_gas,  lfreeze_uext, lcoriolis_force, lcentrifugal_force, ladvection_velocity,  omega_out, omega_in, lprecession, omega_precession, omega_fourier,  alpha_precession, lshear_rateofstrain, r_omega, w_omega,  lconservative, lrelativistic, niter_relB, lalways_use_gij_etc, amp_centforce,  lcalc_uumean, lcalc_uumeanx, lcalc_uumeanxy, lcalc_uumeanxz, lcalc_uumeanz,  lcalc_ruumeanz, lcalc_ruumeanxy,  lforcing_cont_uu, width_ff_uu, x1_ff_uu, x2_ff_uu,  loo_as_aux, luut_as_aux, luust_as_aux, loot_as_aux, loost_as_aux,  llorentz_as_aux, loutest, ldiffrot_test,  interior_bc_hydro_profile, lhydro_bc_interior, z1_interior_bc_hydro,  velocity_ceiling, ekman_friction, ampl_Omega, lcoriolis_xdep,  ampl_forc, k_forc, w_forc, x_forc, dx_forc, ampl_fcont_uu,  lno_meridional_flow, lrotation_xaxis, k_diffrot,Shearx, rescale_uu,  hydro_xaver_range, Ra, Pr, llinearized_hydro, lremove_mean_angmom,  lpropagate_borderuu, hydro_zaver_range, index_rSH,  uzjet, ydampint, ydampext, mean_momentum, lshear_in_coriolis,  lcdt_tauf, cdt_tauf, ulev,  w_sldchar_hyd, uphi_rbot, uphi_rtop, uphi_step_width, lOmega_cyl_xy,  lno_radial_advection, lfargoadvection_as_shift, lhelmholtz_decomp,  limpose_only_horizontal_uumz, luu_fluc_as_aux, Om_inner, luu_sph_as_aux,  ltime_integrals_always, dtcor, lvart_in_shear_frame, lSchur_3D3D1D_uu,  lSchur_2D2D3D_uu, lSchur_2D2D1D_uu
!
...
integer :: idiag_u2tm=0
integer :: idiag_uotm=0
integer :: idiag_outm=0
integer :: idiag_fkinzm=0
integer :: idiag_gamm=0
integer :: idiag_gamrms=0
integer :: idiag_gammax=0
integer :: idiag_u2m=0
integer :: idiag_u2sphm=0
integer :: idiag_um2=0
integer :: idiag_uxpt=0
integer :: idiag_uypt=0
integer :: idiag_uzpt=0
integer :: idiag_uxp2=0
integer :: idiag_uyp2=0
integer :: idiag_uzp2=0
integer :: idiag_uxuypt=0
integer :: idiag_uyuzpt=0
integer :: idiag_uzuxpt=0
integer :: idiag_urms=0
integer :: idiag_urmsx=0
integer :: idiag_urmsz=0
integer :: idiag_durms=0
integer :: idiag_umax=0
integer :: idiag_umin=0
integer :: idiag_uxrms=0
integer :: idiag_uyrms=0
integer :: idiag_uzrms=0
integer :: idiag_uzrmaxs=0
integer :: idiag_uxmin=0
integer :: idiag_uymin=0
integer :: idiag_uzmin=0
integer :: idiag_uxmax=0
integer :: idiag_uymax=0
integer :: idiag_uzmax=0
integer :: idiag_uxm=0
integer :: idiag_uym=0
integer :: idiag_uzm=0
integer :: idiag_uzcx10m=0
integer :: idiag_uzsx10m=0
integer :: idiag_uduum=0
integer :: idiag_ux2m=0
integer :: idiag_uy2m=0
integer :: idiag_uz2m=0
integer :: idiag_ux3m=0
integer :: idiag_uy3m=0
integer :: idiag_uz3m=0
integer :: idiag_ux4m=0
integer :: idiag_uy4m=0
integer :: idiag_uz4m=0
integer :: idiag_uxuy2m=0
integer :: idiag_uyuz2m=0
integer :: idiag_uzux2m=0
integer :: idiag_ux2ccm=0
integer :: idiag_ux2ssm=0
integer :: idiag_uy2ccm=0
integer :: idiag_uy2ssm=0
integer :: idiag_uxuycsm=0
integer :: idiag_uxuym=0
integer :: idiag_uxuzm=0
integer :: idiag_uyuzm=0
integer :: idiag_umx=0
integer :: idiag_umy=0
integer :: idiag_umz=0
integer :: idiag_omumz=0
integer :: idiag_umamz=0
integer :: idiag_umbmz=0
integer :: idiag_umxbmz=0
integer :: idiag_rux2m=0
integer :: idiag_ruy2m=0
integer :: idiag_ruz2m=0
integer :: idiag_divum=0
integer :: idiag_rdivum=0
integer :: idiag_divu2m=0
integer :: idiag_gdivu2m=0
integer :: idiag_u3u21m=0
integer :: idiag_u1u32m=0
integer :: idiag_u2u13m=0
integer :: idiag_u2u31m=0
integer :: idiag_u3u12m=0
integer :: idiag_u1u23m=0
integer :: idiag_urmphi=0
integer :: idiag_upmphi=0
integer :: idiag_uzmphi=0
integer :: idiag_rurmphi=0
integer :: idiag_rupmphi=0
integer :: idiag_ruzmphi=0
integer :: idiag_ur2mphi=0
integer :: idiag_up2mphi=0
integer :: idiag_uz2mphi=0
integer :: idiag_urupmphi=0
integer :: idiag_uruzmphi=0
integer :: idiag_upuzmphi=0
integer :: idiag_rurupmphi=0
integer :: idiag_ruruzmphi=0
integer :: idiag_rupuzmphi=0
integer :: idiag_ursphmphi=0
integer :: idiag_uthmphi=0
integer :: idiag_rursphmphi=0
integer :: idiag_ruthmphi=0
integer :: idiag_u2mphi=0
integer :: idiag_fkinrsphmphi=0
integer :: idiag_u2mr=0
integer :: idiag_urmr=0
integer :: idiag_upmr=0
integer :: idiag_uzmr=0
integer :: idiag_uxfampm=0
integer :: idiag_uyfampm=0
integer :: idiag_uzfampm=0
integer :: idiag_uxfampim=0
integer :: idiag_uyfampim=0
integer :: idiag_uzfampim=0
integer :: idiag_ruxm=0
integer :: idiag_ruym=0
integer :: idiag_ruzm=0
integer :: idiag_ruxtot=0
integer :: idiag_rumax=0
integer :: idiag_ruxuym=0
integer :: idiag_ruxuzm=0
integer :: idiag_ruyuzm=0
integer :: idiag_divrhourms=0
integer :: idiag_divrhoumax=0
integer :: idiag_rlxm=0
integer :: idiag_rlym=0
integer :: idiag_rlzm=0
integer :: idiag_rlx2m=0
integer :: idiag_rly2m=0
integer :: idiag_rlz2m=0
integer :: idiag_tot_ang_mom=0
integer :: idiag_dtu=0
integer :: idiag_oum=0
integer :: idiag_oxum=0
integer :: idiag_ourms=0
integer :: idiag_oxurms=0
integer :: idiag_ou_int=0
integer :: idiag_fum=0
integer :: idiag_odel2um=0
integer :: idiag_o2m=0
integer :: idiag_o2u2m=0
integer :: idiag_o2sphm=0
integer :: idiag_orms=0
integer :: idiag_omax=0
integer :: idiag_ox2m=0
integer :: idiag_oy2m=0
integer :: idiag_oz2m=0
integer :: idiag_ox3m=0
integer :: idiag_oy3m=0
integer :: idiag_oz3m=0
integer :: idiag_ox4m=0
integer :: idiag_oy4m=0
integer :: idiag_oz4m=0
integer :: idiag_oxm=0
integer :: idiag_oym=0
integer :: idiag_ozm=0
integer :: idiag_oxuzxm=0
integer :: idiag_oyuzym=0
integer :: idiag_oxoym=0
integer :: idiag_oxozm=0
integer :: idiag_oyozm=0
integer :: idiag_qfm=0
integer :: idiag_q2m=0
integer :: idiag_qrms=0
integer :: idiag_qmax=0
integer :: idiag_qom=0
integer :: idiag_quxom=0
integer :: idiag_pvzm=0
integer :: idiag_oumphi=0
integer :: idiag_ozmphi=0
integer :: idiag_ormr=0
integer :: idiag_opmr=0
integer :: idiag_ozmr=0
integer :: idiag_uguxm=0
integer :: idiag_uguym=0
integer :: idiag_uguzm=0
integer :: idiag_ugurmsx=0
integer :: idiag_ugu2m=0
integer :: idiag_dudx=0
integer :: idiag_Marms=0
integer :: idiag_Mamax=0
integer :: idiag_fintm=0
integer :: idiag_fextm=0
integer :: idiag_duxdzma=0
integer :: idiag_duydzma=0
integer :: idiag_EEK=0
integer :: idiag_ekin=0
integer :: idiag_ekintot=0
integer :: idiag_totangmom=0
integer :: idiag_uxglnrym=0
integer :: idiag_uyglnrxm=0
integer :: idiag_uzdivum=0
integer :: idiag_uxuydivum=0
integer :: idiag_divuHrms=0
integer :: idiag_uxxrms=0
integer :: idiag_uyyrms=0
integer :: idiag_uxzrms=0
integer :: idiag_uyzrms=0
integer :: idiag_uzyrms=0
...
integer, dimension(Nmodes_SH) :: idiag_urlm=0
integer :: idiag_udpxxm=0,  idiag_udpyym=0,  idiag_udpzzm=0,  idiag_udpxym=0,  idiag_udpyzm=0,  idiag_udpxzm=0
!
...
integer :: idiag_u2mz=0
integer :: idiag_o2mz=0
integer :: idiag_divu2mz=0
integer :: idiag_curlru2mz=0
integer :: idiag_divru2mz=0
integer :: idiag_fmasszmz=0
integer :: idiag_fkinzmz=0
integer :: idiag_fkinzupmz=0
integer :: idiag_fkinzdownmz=0
integer :: idiag_uxmz=0
integer :: idiag_uymz=0
integer :: idiag_uzmz=0
integer :: idiag_ffdownmz=0
integer :: idiag_uzupmz=0
integer :: idiag_uzdownmz=0
integer :: idiag_ruzupmz=0
integer :: idiag_ruzdownmz=0
integer :: idiag_divumz=0
integer :: idiag_uzdivumz=0
integer :: idiag_oxmz=0
integer :: idiag_oymz=0
integer :: idiag_ozmz=0
integer :: idiag_ux2mz=0
integer :: idiag_uy2mz=0
integer :: idiag_uz2mz=0
integer :: idiag_uz2upmz=0
integer :: idiag_uz2downmz=0
integer :: idiag_ox2mz=0
integer :: idiag_oy2mz=0
integer :: idiag_oz2mz=0
integer :: idiag_ruxmz=0
integer :: idiag_ruymz=0
integer :: idiag_ruzmz=0
integer :: idiag_rux2mz=0
integer :: idiag_ruy2mz=0
integer :: idiag_ruz2mz=0
integer :: idiag_uxuymz=0
integer :: idiag_uxuzmz=0
integer :: idiag_uyuzmz=0
integer :: idiag_Rxymz=0
integer :: idiag_Rxyupmz=0
integer :: idiag_Rxydownmz=0
integer :: idiag_Rxzmz=0
integer :: idiag_Rxzupmz=0
integer :: idiag_Rxzdownmz=0
integer :: idiag_Ryzmz=0
integer :: idiag_Ryzupmz=0
integer :: idiag_Ryzdownmz=0
integer :: idiag_ruxuymz=0
integer :: idiag_ruxuzmz=0
integer :: idiag_ruyuzmz=0
integer :: idiag_ruxuy2mz=0
integer :: idiag_ruxuz2mz=0
integer :: idiag_ruyuz2mz=0
integer :: idiag_oxuxxmz=0
integer :: idiag_oyuxymz=0
integer :: idiag_oxuyxmz=0
integer :: idiag_oyuyymz=0
integer :: idiag_oxuzxmz=0
integer :: idiag_oyuzymz=0
integer :: idiag_uyxuzxmz=0
integer :: idiag_uyyuzymz=0
integer :: idiag_uyzuzzmz=0
integer :: idiag_ekinmz=0
integer :: idiag_oumz=0
integer :: idiag_uguxmz=0
integer :: idiag_uguymz=0
integer :: idiag_uguzmz=0
integer :: idiag_Remz=0
integer :: idiag_oguxmz=0
integer :: idiag_oguymz=0
integer :: idiag_oguzmz=0
integer :: idiag_ogux2mz=0
integer :: idiag_oguy2mz=0
integer :: idiag_oguz2mz=0
integer :: idiag_oxdivumz=0
integer :: idiag_oydivumz=0
integer :: idiag_ozdivumz=0
integer :: idiag_oxdivu2mz=0
integer :: idiag_oydivu2mz=0
integer :: idiag_ozdivu2mz=0
integer :: idiag_u3u21mz=0
integer :: idiag_u1u32mz=0
integer :: idiag_u2u13mz=0
integer :: idiag_u2u31mz=0
integer :: idiag_u3u12mz=0
integer :: idiag_u1u23mz=0
integer :: idiag_acczmz=0
integer :: idiag_acczupmz=0
integer :: idiag_acczdownmz=0
integer :: idiag_accpowzmz=0
integer :: idiag_accpowzupmz=0
integer :: idiag_accpowzdownmz=0
integer :: idiag_totalforcezmz=0
integer :: idiag_totalforcezupmz=0
integer :: idiag_totalforcezdownmz=0
!
...
integer :: idiag_uxmy=0
integer :: idiag_uymy=0
integer :: idiag_uzmy=0
integer :: idiag_ux2my=0
integer :: idiag_uy2my=0
integer :: idiag_uz2my=0
integer :: idiag_uxuymy=0
integer :: idiag_uxuzmy=0
integer :: idiag_uyuzmy=0
integer :: idiag_oumy=0
integer :: idiag_uguxmy=0
integer :: idiag_uguymy=0
integer :: idiag_uguzmy=0
!
...
integer :: idiag_uxmx=0
integer :: idiag_uymx=0
integer :: idiag_uzmx=0
integer :: idiag_ruxmx=0
integer :: idiag_ruymx=0
integer :: idiag_ruzmx=0
integer :: idiag_rux2mx = 0
integer :: idiag_ruy2mx = 0
integer :: idiag_ruz2mx = 0
integer :: idiag_ruxuymx = 0
integer :: idiag_ruxuzmx = 0
integer :: idiag_ruyuzmx = 0
integer :: idiag_ux2mx=0
integer :: idiag_uy2mx=0
integer :: idiag_uz2mx=0
integer :: idiag_ox2mx=0
integer :: idiag_oy2mx=0
integer :: idiag_oz2mx=0
integer :: idiag_uxuymx=0
integer :: idiag_uxuzmx=0
integer :: idiag_uyuzmx=0
integer :: idiag_oumx=0
integer :: idiag_uguxmx=0
integer :: idiag_uguymx=0
integer :: idiag_uguzmx=0
integer :: idiag_ekinmx=0
integer :: idiag_fkinxmx=0
!
...
integer :: idiag_uxmxz=0
integer :: idiag_uymxz=0
integer :: idiag_uzmxz=0
integer :: idiag_ux2mxz=0
integer :: idiag_uy2mxz=0
integer :: idiag_uz2mxz=0
integer :: idiag_uxuymxz=0
integer :: idiag_uxuzmxz=0
integer :: idiag_uyuzmxz=0
integer :: idiag_oumxz=0
!
...
integer :: idiag_uxmxy=0
integer :: idiag_uymxy=0
integer :: idiag_uzmxy=0
integer :: idiag_uxupmxy=0
integer :: idiag_uxdownmxy=0
integer :: idiag_ruxupmxy=0
integer :: idiag_ruxdownmxy=0
integer :: idiag_ux2upmxy=0
integer :: idiag_ux2downmxy=0
integer :: idiag_ffdownmxy=0
integer :: idiag_uxuymxy=0
integer :: idiag_uxuzmxy=0
integer :: idiag_uyuzmxy=0
integer :: idiag_Rxymxy=0
integer :: idiag_Rxyupmxy=0
integer :: idiag_Rxydownmxy=0
integer :: idiag_Rxzmxy=0
integer :: idiag_Rxzupmxy=0
integer :: idiag_Rxzdownmxy=0
integer :: idiag_Ryzmxy=0
integer :: idiag_Ryzupmxy=0
integer :: idiag_Ryzdownmxy=0
integer :: idiag_oxmxy=0
integer :: idiag_oymxy=0
integer :: idiag_ozmxy=0
integer :: idiag_oumxy=0
integer :: idiag_pvzmxy=0
integer :: idiag_uguxmxy=0
integer :: idiag_uguymxy=0
integer :: idiag_uguzmxy=0
integer :: idiag_ruxmxy=0
integer :: idiag_ruymxy=0
integer :: idiag_ruzmxy=0
integer :: idiag_ux2mxy=0
integer :: idiag_uy2mxy=0
integer :: idiag_uz2mxy=0
integer :: idiag_rux2mxy=0
integer :: idiag_ruy2mxy=0
integer :: idiag_ruz2mxy=0
integer :: idiag_ruxuymxy=0
integer :: idiag_ruxuzmxy=0
integer :: idiag_ruyuzmxy=0
integer :: idiag_fkinxmxy=0
integer :: idiag_fkinymxy=0
integer :: idiag_fkinxupmxy=0
integer :: idiag_fkinxdownmxy=0
...
if (llorentz_as_aux) call warning('register_hydro',  'no Lorentz factor without lconservative or lrelativistic')
endif
endif
!
...
if (ldamp_fade .and. (tfade_start >= tdamp) .and. (tdamp > 0.0))  call fatal_error ('initialize_hydro', 'Please set tfade_start < tdamp')
...
if (lroot) print*,  'initialize_hydro: 0-D run, turned off advection of velocity'
endif
!
...
if (lpropagate_borderuu     .and.  borderuu(1)/='nothing' .and.  borderuu(2)=='nothing' .and.  borderuu(3)=='nothing') then
...
lcalc_uumeanz = lcalc_uumeanz .or. lcalc_uumean .or. ltestfield_xz .or.  lremove_uumeanz .or. lremove_uumeanz_horizontal .or. lSchur_3D3D1D_uu
...
if (lremove_mean_flow) call warning('initialize_hydro',  'lremove_mean_flow=T may interfere with lremove_uumean[xyz]=T')
if (lremove_mean_momenta) call warning('initialize_hydro',  'lremove_mean_momenta=T may interfere with lremove_uumean[xyz]=T')
if (lremove_uumeanxy) call warning('initialize_hydro',  'lremove_uumeanxy=T may interfere with lremove_uumean[xyz]=T')
endif
!
...
if (.not.lcalc_uumean)  call fatal_error("initialize_hydro","you need to set lcalc_uumean=T for uuprof='remove_vertical_shear'")
...
if (.not.lcalc_uumeanxz)  call fatal_error("initialize_hydro","you need to set lcalc_uumeanxz=T for uuprof='vertical_shear_z2'")
prof_amp3=ampl1_diffrot*tanh((z-rdampint)/width_ff_uu)
case ('vertical_shear_linear')
if (.not.lcalc_uumeanxz)  call fatal_error("initialize_hydro","you need to set lcalc_uumeanxz=T for uuprof='vertical_shear_linear'")
...
call fatal_error("initialize_hydro",  "uuprof='solar_simple' not implemented for other than spherical or Cartesian coordinates")
endif
...
case ('radial_shear')
if (.not.lcalc_uumeanxy)  call fatal_error("initialize_hydro","you need to set lcalc_uumeanxy=T for uuprof='radial_shear'")
prof_amp1=ampl1_diffrot*cos(2*pi*k_diffrot*(x(l1:l2)-x0)/Lx)
case ('radial_shear_damp')
if (.not.lcalc_uumeanxy)  call fatal_error("initialize_hydro","you need to set lcalc_uumeanxy=T for uuprof='radial_shear_damp'")
prof_amp1=ampl1_diffrot*tanh((x(l1:l2)-rdampint)/wdamp)
case ('damp_corona')
if (lspherical_coords) then
if (.not.lcalc_uumeanxy)  call fatal_error("initialize_hydro","you need to set lcalc_uumeanxy=T for uuprof='damp_corona'")
...
if (.not.lcalc_uumeanxy)  call fatal_error("initialize_hydro","you need to set lcalc_uumeanxy=T for uuprof='latitudinal_shear'")
prof_amp4=ampl1_diffrot*cos(2.*pi*k_diffrot*(y-y0)/Ly)
case ('damp_jets')
if (.not.lcalc_uumeanxy)  call fatal_error("initialize_hydro","you need to set lcalc_uumeanxy=T for uuprof='damp_jets'")
prof_amp4=1.-0.5*(1.+tanh((y-(y0+ydampint))/wdamp)-(1.+tanh((y-(y0+Lxyz(2)-ydampext))/wdamp)))
case ('spoke-like-NSSL')
if (.not.lspherical_coords)  call warning("initialize_hydro",  "uuprof='spoke-like-NSSL' only meningful for spherical coordinates")
if (.not.lcalc_uumeanxy)  call fatal_error("initialize_hydro","you need lcalc_uumeanxy=T for uuprof='spoke-like-NSSL'")
...
profx_diffrot2=(x(l1:l2)-uphi_rbot)*profx_diffrot1*profx_diffrot2
...
if (.not.lgravz)  call fatal_error("initialize_hydro","gravitation in z-direction (lgravz=T) needed for uuprof='uumz_profile'")
call read_uumz_profile(uumz_prof)
endif
case ('omega_profile')
if (.not.lspherical_coords)  call warning("initialize_hydro",  "uuprof='omega_profile' only meaningful for spherical coordinates")
if (.not.lcalc_uumeanxy)  call fatal_error("initialize_hydro","you need to set lcalc_uumeanxy=T for uuprof='omega_profile'")
...
if (ivid_uu_sph/=0)  call alloc_slice_buffers(uu_sph_xy,uu_sph_xz,uu_sph_yz,uu_sph_xy2,uu_sph_xy3,uu_sph_xy4,uu_sph_xz2,uu_sph_r)
!
...
uumxy(:,:,j)=fact*sum(f(:,:,n1:n2,iuu+j-1),3)
endif
enddo
...
ruumxy(:,:,j)=fact*sum(exp(f(:,:,n1:n2,ilnrho))*f(:,:,n1:n2,iuu+j-1),3)
endif
enddo
...
do n=n1,n2; do m=m1,m2
f(l1:l2,m,n,iux)= 0.5*ampluu(j)*(1.4*cos(kx_uu*x(l1:l2))*sin(ky_uu*y(m))+  sin(kx_uu*x(l1:l2))*cos(ky_uu*y(m)))
f(l1:l2,m,n,iuy)=-0.5*ampluu(j)*(1.4*sin(kx_uu*x(l1:l2))*cos(ky_uu*y(m))+  cos(kx_uu*x(l1:l2))*sin(ky_uu*y(m)))
f(l1:l2,m,n,iuz)= 0.5*ampluu(j)*(1.4*sin(kx_uu*x(l1:l2))*sin(ky_uu*y(m))-  2.*cos(kx_uu*x(l1:l2))*cos(ky_uu*y(m)))
enddo; enddo
!
...
do m=m1,m2
der=2./delta_u
prof=ampluu(j)*( tanh(der*(y(m)+widthuu))- tanh(der*(y(m)-widthuu)))/2.
do n=n1,n2
f(l1:l2,m,n,iux)=prof
enddo
enddo
...
do n=n1,n2; do m=m1,m2
f(l1:l2,m,n,iux)=uu_const(1)+f(l1:l2,m,n,iux)  +ampluu(j)*exp(-((x(l1:l2)-xsphere)**2+  (y(m)-ysphere)**2+  (z(n)-zsphere)**2)/widthuu**2)
enddo; enddo
!
...
do n=n1,n2; do m=m1,m2
prof = ampluu(j)*exp(-0.5*(z(n)-z1)**2/widthuu**2)
tmp = kx_uu*x(l1:l2) + ky_uu*y(m)
...
do n=n1,n2; do m=m1,m2
prof = ampluu(j)*exp(-0.5*(z(n)-z1)**2/widthuu**2)
tmp = sqrt((x(l1:l2)-(x0+0.3*Lx))**2+(y(m)-(y0+0.3*Ly))**2)
f(l1:l2,m,n,iuz) = prof*exp(-0.5*(tmp**2)/widthuu**2)
tmp = sqrt((x(l1:l2)-(x0+0.5*Lx))**2+(y(m)-(y0+0.8*Ly))**2)
...
call power_randomphase_hel(ampluu(j),initpower,initpower2,  cutoff,ncutoff,kpeak,f,iux,iuz,relhel_uu,kgaussian_uu,  lskip_projection, lvectorpotential,lscale_tobox,  nfact0=nfact_uu, lfactors0=lfactors_uu,  lno_noise=lno_noise_uu, qirro=qirro_uu)
!
...
do n=n1,n2; do m=m1,m2
tmp = -kx_uu*ampl_uy(j)*eta_sigma*  (cos(kx_uu*x(l1:l2)+ky_uu*y(m)+kz_uu*z(n)) +  sin(kx_uu*x(l1:l2)+ky_uu*y(m)+kz_uu*z(n)))
...
f(l1:l2,m,n,iuz)=f(l1:l2,m,n,iuz)+tmp(ixy)*ampluu(j)  *exp(-kx_uu*(x(l1:l2)-xc0(ixy))**2-ky_uu*(y(m)-yc0(ixy))**2)  *exp(-kz_uu*z(n)**2)
!
...
if (.not.lspherical_coords) call fatal_error("init_uu",  "spher-harm-poloidal only meaningful for spherical coordinates")
if (n_xprof(j)==-1) then
tmp=(x(l1:l2)-xyz0(1))*(x(l1:l2)-xyz1(1))
prof=tmp/x(l1:l2) + 2.*x(l1:l2)-(xyz0(1)+xyz1(1))
else
tmp=sin((2.*pi/(Lxyz(1))*n_xprof(j))*(x(l1:l2)-xyz0(1)))
...
if (mm_sh(j)/=0)  f(l1:l2,m,n,iuz) = -prof*sph*mm_sh(j)/sinth(m)* sin(mm_sh(j)*z(n))/cos(mm_sh(j)*z(n))
enddo
enddo
endif
!
...
if (.not.lspherical_coords) call fatal_error("init_uu",  "parker_wind only meaningful for spherical coordinates")
!
...
if (lparticles_lyapunov .or. lparticles_caustics .or. lparticles_tetrad)  lpenc_requested(i_uij) = .true.
...
if (idiag_oumphi/=0 .or. idiag_oumxy/=0 .or.  idiag_oumxz/=0) lpenc_diagnos2d(i_ou)=.true.
if (idiag_ozmphi/=0) lpenc_diagnos2d(i_oo)=.true.
if (idiag_u2mphi/=0) lpenc_diagnos2d(i_u2)=.true.
if (idiag_ox2m/=0 .or. idiag_oy2m/=0 .or. idiag_oz2m/=0 .or.  idiag_ox3m/=0 .or. idiag_oy3m/=0 .or. idiag_oz3m/=0 .or.  idiag_ox4m/=0 .or. idiag_oy4m/=0 .or. idiag_oz4m/=0 .or.  idiag_oxm /=0 .or. idiag_oym /=0 .or. idiag_ozm /=0 .or.  idiag_oxoym/=0 .or. idiag_oxozm/=0 .or. idiag_oyozm/=0 .or.  idiag_oxuzxm/=0 .or. idiag_oyuzym/=0 .or.  idiag_pvzm /=0 .or. idiag_quxom/=0)  lpenc_diagnos(i_oo)=.true.
if (idiag_orms/=0 .or. idiag_omax/=0 .or. idiag_o2m/=0 .or. idiag_o2u2m/=0 .or. idiag_o2sphm/=0 .or.  idiag_ormsh/=0 .or. idiag_o2mz/=0 ) lpenc_diagnos(i_o2)=.true.
if (idiag_q2m/=0 .or. idiag_qrms/=0 .or. idiag_qmax/=0 .or.  idiag_qfm/=0 .or. idiag_qom/=0 .or. idiag_quxom/=0)  lpenc_diagnos(i_curlo)=.true.
if (idiag_divu2m/=0 .or. idiag_divu2mz/=0 .or. idiag_divru2mz/=0 .or.  idiag_divum/=0 .or. idiag_rdivum/=0) lpenc_diagnos(i_divu)=.true.
if (idiag_rdivum/=0 .or. idiag_fkinzm/=0 .or. idiag_ruzupmz/=0 .or. idiag_ruzdownmz/=0)  lpenc_diagnos(i_rho)=.true.
if (idiag_ruxupmxy/=0 .or. idiag_ruxdownmxy/=0)  lpenc_diagnos2d(i_rho)=.true.
if (idiag_gdivu2m/=0) lpenc_diagnos(i_graddivu)=.true.
if (idiag_oum/=0 .or. idiag_ourms/=0 .or. idiag_oumx/=0 .or. idiag_oumy/=0 .or.  idiag_oumz/=0 .or. idiag_oumh/=0 .or. idiag_ou_int/=0 ) lpenc_diagnos(i_ou)=.true.
...
if (idiag_acczmz/=0 .or. idiag_acczupmz/=0 .or. idiag_acczdownmz/=0 .or.  idiag_accpowzmz/=0 .or. idiag_accpowzupmz/=0 .or. idiag_accpowzdownmz/=0 .or.  idiag_totalforcezmz/=0 .or. idiag_totalforcezupmz/=0 .or.  idiag_totalforcezdownmz/=0) then
lpenc_diagnos(i_fpres)=.true.; lpenc_diagnos(i_fvisc)=.true.
if (lgrav) lpenc_diagnos(i_gg)=.true.
endif
if (idiag_urms/=0 .or. idiag_durms/=0 .or.  idiag_umax/=0 .or. idiag_rumax/=0 .or.  idiag_fkinzm/=0 .or. idiag_u2m/=0 .or. idiag_um2/=0 .or. idiag_u2mz/=0 .or.  idiag_urmsh/=0 .or. idiag_urmsx/=0 .or. idiag_urmsz/=0 .or. idiag_u2sphm/=0)  lpenc_diagnos(i_u2)=.true.
...
if (idiag_fmasszmz/=0 .or. idiag_ruxuym/=0 .or.  idiag_ruxm/=0 .or. idiag_ruym/=0 .or. idiag_ruzm/=0 .or.  idiag_ruxuzm/=0 .or. idiag_ruyuzm/=0 .or. idiag_pvzm/=0 .or.  idiag_ruxtot/=0) lpenc_diagnos(i_rho)=.true.
if (idiag_ruxmz/=0 .or. idiag_ruymz/=0 .or. idiag_ruzmz/=0 .or.  idiag_rux2mz/=0 .or. idiag_ruy2mz/=0 .or. idiag_ruz2mz/=0 .or.  idiag_ruxmx/=0 .or. idiag_ruymx/=0 .or. idiag_ruzmx/=0 .or.  idiag_ruxuymz/=0 .or. idiag_ruxuzmz/=0 .or. idiag_ruyuzmz/=0 .or.  idiag_ruxuy2mz/=0 .or. idiag_ruxuz2mz/=0 .or. idiag_ruyuz2mz/=0 .or. idiag_uduum/=0)  lpenc_diagnos(i_rho)=.true.
if (idiag_rux2mx /= 0 .or. idiag_ruy2mx /= 0 .or. idiag_ruz2mx /= 0 .or.  idiag_ruxuymx /= 0 .or. idiag_ruxuzmx /= 0 .or. idiag_ruyuzmx /= 0 .or.  idiag_rurmphi/=0 .or. idiag_rupmphi/=0 .or. idiag_ruzmphi/=0 .or.  idiag_rurupmphi/=0 .or. idiag_ruruzmphi/=0 .or. idiag_rursphmphi/=0 .or.  idiag_ruthmphi/=0) lpenc_diagnos(i_rho) = .true.
if (idiag_ormr/=0 .or. idiag_opmr/=0 .or. idiag_ozmr/=0)  lpenc_diagnos(i_oo)=.true.
if (idiag_oxmxy/=0 .or. idiag_oymxy/=0 .or. idiag_ozmxy/=0 .or.  idiag_oxmz/=0 .or. idiag_oymz/=0 .or. idiag_ozmz/=0 .or.  idiag_ox2mz/=0 .or. idiag_oy2mz/=0 .or. idiag_oz2mz/=0 .or.  idiag_pvzmxy/=0)  lpenc_diagnos2d(i_oo)=.true.
if (idiag_pvzmxy/=0) lpenc_diagnos2d(i_rho)=.true.
if (idiag_totangmom/=0 ) lpenc_diagnos(i_rcyl_mn)=.true.
if (idiag_urmr/=0 .or.  idiag_ormr/=0 .or. idiag_urmphi/=0 .or. idiag_rurmphi/=0 .or.  idiag_ur2mphi/=0 .or. idiag_urupmphi/=0 .or. idiag_uruzmphi/=0 .or.  idiag_rurupmphi/=0 .or. idiag_ruruzmphi/=0) then
lpenc_diagnos(i_pomx)=.true.
lpenc_diagnos(i_pomy)=.true.
endif
if (idiag_ursphmphi/=0 .or. idiag_rursphmphi/=0 .or. idiag_fkinrsphmphi/=0)  lpenc_diagnos2d(i_evr)=.true.
if (idiag_uthmphi/=0 .or. idiag_ruthmphi/=0) lpenc_diagnos2d(i_evth)=.true.
if (idiag_upmr/=0 .or. idiag_opmr/=0 .or. idiag_upmphi/=0 .or. idiag_rupmphi/=0 .or.  idiag_up2mphi/=0 .or. idiag_urupmphi/=0 .or. idiag_upuzmphi/=0 .or.  idiag_rurupmphi/=0 .or. idiag_rupuzmphi/=0) then
lpenc_diagnos(i_phix)=.true.
lpenc_diagnos(i_phiy)=.true.
endif
if (idiag_EEK/=0 .or. idiag_ekin/=0 .or. idiag_ekintot/=0 .or. idiag_fkinzmz/=0 .or.  idiag_fkinzupmz/=0 .or. idiag_fkinzdownmz/=0 .or.  idiag_ekinmx /= 0 .or. idiag_ekinmz/=0 .or. idiag_fkinxmx/=0) then
lpenc_diagnos(i_ekin)=.true.
endif
if (idiag_fkinxmxy/=0 .or. idiag_fkinymxy/=0 .or.  idiag_fkinxupmxy/=0 .or. idiag_fkinxdownmxy/=0 .or. idiag_fkinrsphmphi/=0) then
lpenc_diagnos2d(i_uu)=.true.
lpenc_diagnos2d(i_ekin)=.true.
endif
if (idiag_uxmxy/=0 .or. idiag_uymxy/=0 .or. idiag_uzmxy/=0 .or.  idiag_ux2mxy/=0 .or. idiag_uy2mxy/=0 .or. idiag_uz2mxy/=0 .or.  idiag_ruxmxy/=0 .or. idiag_ruymxy/=0 .or. idiag_ruzmxy/=0 .or.   idiag_uxuymxy/=0 .or. idiag_uxuzmxy/=0 .or. idiag_uyuzmxy/=0 .or.  idiag_ruxuymxy/=0 .or. idiag_ruxuzmxy/=0 .or.  idiag_uxupmxy/=0 .or. idiag_uxdownmxy/=0 .or.  idiag_ux2upmxy/=0 .or. idiag_ux2downmxy/=0 .or.  idiag_ruxupmxy/=0 .or. idiag_ruxdownmxy/=0 .or.  idiag_ruyuzmxy/=0 .or. idiag_ffdownmxy/=0) then
lpenc_diagnos2d(i_uu)=.true.
endif
if (idiag_ruxmxy/=0 .or. idiag_ruymxy/=0 .or. idiag_ruzmxy/=0 .or.  idiag_ruxuymxy/=0 .or. idiag_ruxuzmxy/=0 .or. idiag_ruyuzmxy/=0)  lpenc_diagnos2d(i_rho)=.true.
if (idiag_uguxm/=0 .or. idiag_uguym/=0 .or. idiag_uguzm/=0)  lpenc_diagnos(i_ugu)=.true.
if (idiag_uguxmxy/=0 .or. idiag_uguymxy/=0 .or. idiag_uguzmxy/=0)  lpenc_diagnos2d(i_ugu)=.true.
!

if (idiag_ugu2m/=0 .or. idiag_ugurmsx/=0) lpenc_diagnos(i_ugu2)=.true.
if (idiag_uguxmx/=0 .or. idiag_uguymx/=0 .or. idiag_uguzmx/=0 .or.  idiag_uguxmy/=0 .or. idiag_uguymy/=0 .or. idiag_uguzmy/=0 .or.  idiag_uguxmz/=0 .or. idiag_uguymz/=0 .or. idiag_uguzmz/=0)  lpenc_diagnos(i_ugu)=.true.
!
...
if (idiag_oguxmz/=0 .or. idiag_oguymz/=0 .or. idiag_oguzmz/=0 .or.  idiag_ogux2mz/=0 .or. idiag_oguy2mz/=0 .or. idiag_oguz2mz/=0)  lpenc_diagnos(i_ogu)=.true.
!

if (idiag_oxdivumz/=0  .or. idiag_oydivumz/=0  .or. idiag_ozdivumz/=0 .or.  idiag_oxdivu2mz/=0 .or. idiag_oydivu2mz/=0 .or. idiag_ozdivu2mz/=0) then
lpenc_diagnos(i_oo)=.true.
lpenc_diagnos(i_divu)=.true.
endif
!

if (idiag_udpxxm/=0 .or. idiag_udpyym/=0 .or. idiag_udpzzm/=0 .or.  idiag_udpxym/=0 .or. idiag_udpyzm/=0 .or. idiag_udpxzm/=0) then
lpenc_diagnos(i_uu)=.true.
...
call fatal_error("pencil_criteria_hydro","You have to set either of"//  "lequatory or lequatorz to true to calculate averages over half the box")
else
...
if (lpencil_in(i_u3u21) .or.  lpencil_in(i_u1u32) .or.  lpencil_in(i_u2u13) .or.  lpencil_in(i_u2u31) .or.  lpencil_in(i_u3u12) .or.  lpencil_in(i_u1u23)) then
lpencil_in(i_uu)=.true.
lpencil_in(i_uij)=.true.
endif
!
...
use Sub, only: multsv_mn, del2v_etc, gij_etc, u_dot_grad, del6v,  dot2_mn, gij, div_mn, traceless_strain, curl_mn, multm2_sym_mn,  dot_mn, cross, del4v, del4graddiv, d2fi_dxj, del2fi_dxjk, h_dot_grad,  invmat_DB, multmv
...
!  uu is directly p%uu=f(l1:l2,m,n,iux:iuz), but with lconservative
...
if (lcartesian_coords) call fatal_error("calc_pencils_hydro_nonlinear", "der6u_res: This pencil is not implemented for Cartesian coordinates")
do j=1,3
ju=j+iuu-1
do i=1,3
...
call weno_transp(f,m,n,iux,irho,iux,iuy,iuz,p%transpurho(:,1),dx_1,dy_1,dz_1,  ref1=reference_state(:,iref_rho))
call weno_transp(f,m,n,iuy,irho,iux,iuy,iuz,p%transpurho(:,2),dx_1,dy_1,dz_1,  ref1=reference_state(:,iref_rho))
call weno_transp(f,m,n,iuz,irho,iux,iuy,iuz,p%transpurho(:,3),dx_1,dy_1,dz_1,  ref1=reference_state(:,iref_rho))
else
...
if (lpenc_loc(i_o2) .or. lpenc_loc(i_oxu2))  call fatal_error('calc_pencils_hydro_linearized:','does not calculate o2 or oxu2 pencils')
! ou

if (lpenc_loc(i_ou) .or. lpenc_loc(i_oxu))  call fatal_error('calc_pencils_hydro_linearized:','does not calculate ou or oxu pencils')
! ugu
...
if (lconservative) then
call fatal_error('calc_pencils_hydro_linearized:',  'does not calculate ugu pencil in lconservative case')
else
...
if (lpenc_loc(i_u3u21).or.lpenc_loc(i_u1u32).or.lpenc_loc(i_u2u13)   .or.lpenc_loc(i_u2u31).or.lpenc_loc(i_u3u12).or.lpenc_loc(i_u1u23) ) then
...
if (lpenc_loc(i_transpurho))  call fatal_error('calc_pencils_hydro_linearized:','no linearized weno transport ')
!
...
if (ladvection_velocity) then
if (.not. lconservative .and. .not. lweno_transport .and.  .not. lno_meridional_flow .and. .not. lfargo_advection) then
...
advec_uu=max(abs(p%uu(:,1))*dline_1(:,1), abs(p%uu(:,2))*dline_1(:,2), abs(p%uu(:,3))*dline_1(:,3))
else
if (lfargo_advection) then
...
if (idiag_totangmom/=0)  call sum_lim_mn_name(p%rho*(p%uu(:,2)*x(l1:l2)-p%uu(:,1)*y(m)), idiag_totangmom,p)
...
if (idiag_tot_ang_mom/=0) call integrate_mn_name(  p%rho*x(l1:l2)*sin(y(m))*p%uu(:,3),idiag_tot_ang_mom)
!
...
if (idiag_uxfampm/=0 .or. idiag_uyfampm/=0 .or. idiag_uzfampm/=0 .or. idiag_uxfampim/=0 .or. idiag_uxfampim/=0 .or. idiag_uzfampim/=0) then
...
if (idiag_uzupmz/=0 .or. idiag_ruzupmz/=0 .or. idiag_uz2upmz/=0 .or.  idiag_fkinzupmz/=0 .or. idiag_Rxyupmz/=0 .or. idiag_Rxzupmz/=0 .or.  idiag_Ryzupmz/=0) then
where (p%uu(:,3) > 0.)
uus = p%uu(:,3)
...
if (idiag_Rxyupmz/=0) call  xysum_mn_name_z(uzmask*f(l1:l2,m,n,iuu_flucx)*f(l1:l2,m,n,iuu_flucy),idiag_Rxyupmz)
if (idiag_Rxzupmz/=0) call  xysum_mn_name_z(uzmask*f(l1:l2,m,n,iuu_flucx)*f(l1:l2,m,n,iuu_flucz),idiag_Rxzupmz)
if (idiag_Ryzupmz/=0) call  xysum_mn_name_z(uzmask*f(l1:l2,m,n,iuu_flucy)*f(l1:l2,m,n,iuu_flucz),idiag_Ryzupmz)
endif
if (idiag_ffdownmz/=0 .or. idiag_uzupmz/=0 .or. idiag_ruzupmz/=0 .or.  idiag_uz2upmz/=0 .or. idiag_fkinzupmz/=0 .or. idiag_Rxydownmz/=0 .or.  idiag_Rxzdownmz/=0 .or. idiag_Ryzdownmz/=0) then
where (p%uu(:,3) < 0.)
uus = p%uu(:,3)
uzmask = -p%uu(:,3)/abs(p%uu(:,3))
elsewhere
...
if (idiag_Rxydownmz/=0) call  xysum_mn_name_z(uzmask*f(l1:l2,m,n,iuu_flucx)*f(l1:l2,m,n,iuu_flucy),idiag_Rxydownmz)
if (idiag_Rxzdownmz/=0) call  xysum_mn_name_z(uzmask*f(l1:l2,m,n,iuu_flucx)*f(l1:l2,m,n,iuu_flucz),idiag_Rxzdownmz)
if (idiag_Ryzdownmz/=0) call  xysum_mn_name_z(uzmask*f(l1:l2,m,n,iuu_flucy)*f(l1:l2,m,n,iuu_flucz),idiag_Ryzdownmz)
endif
!
...
call xysum_mn_name_z(uus,idiag_acczmz)
endif
...
uus=0.
endwhere
call xysum_mn_name_z(uus,idiag_acczupmz)
endif
...
uus=0.
endwhere
call xysum_mn_name_z(uus,idiag_acczdownmz)
endif
!
...
if (lgrav) uus = uus + p%gg(:,3)
uus=p%uu(:,3)*uus
call xysum_mn_name_z(uus,idiag_accpowzmz)
endif
...
uus=0.
endwhere
call xysum_mn_name_z(uus,idiag_accpowzupmz)
endif
...
uus=0.
endwhere
call xysum_mn_name_z(uus,idiag_accpowzdownmz)
endif
!
...
if (idiag_ursphmphi/=0)  call phisum_mn_name_rz(p%uu(:,1)*p%evr(:,1)+  p%uu(:,2)*p%evr(:,2)+p%uu(:,3)*p%evr(:,3),idiag_ursphmphi)
if (idiag_uthmphi/=0)  call phisum_mn_name_rz(p%uu(:,1)*p%evth(:,1)+  p%uu(:,2)*p%evth(:,2)+p%uu(:,3)*p%evth(:,3),idiag_uthmphi)
if (idiag_rursphmphi/=0)  call phisum_mn_name_rz(p%rho*(p%uu(:,1)*p%evr(:,1)+  p%uu(:,2)*p%evr(:,2)+p%uu(:,3)*p%evr(:,3)),idiag_rursphmphi)
if (idiag_ruthmphi/=0)  call phisum_mn_name_rz(p%rho*(p%uu(:,1)*p%evth(:,1)+  p%uu(:,2)*p%evth(:,2)+p%uu(:,3)*p%evth(:,3)),idiag_ruthmphi)
...
if (idiag_urupmphi/=0)  call phisum_mn_name_rz((p%uu(:,1)*p%pomx+p%uu(:,2)*p%pomy)*(p%uu(:,1)*p%phix+p%uu(:,2)*p%phiy),idiag_urupmphi)
if (idiag_uruzmphi/=0)  call phisum_mn_name_rz((p%uu(:,1)*p%pomx+p%uu(:,2)*p%pomy)*p%uu(:,3),idiag_uruzmphi)
if (idiag_upuzmphi/=0)  call phisum_mn_name_rz((p%uu(:,1)*p%phix+p%uu(:,2)*p%phiy)*p%uu(:,3),idiag_upuzmphi)
if (idiag_rurupmphi/=0)  call phisum_mn_name_rz(p%rho*(p%uu(:,1)*p%pomx+p%uu(:,2)*p%pomy)*(p%uu(:,1)*p%phix+p%uu(:,2)*p%phiy),idiag_rurupmphi)
if (idiag_ruruzmphi/=0)  call phisum_mn_name_rz(p%rho*(p%uu(:,1)*p%pomx+p%uu(:,2)*p%pomy)*p%uu(:,3),idiag_ruruzmphi)
if (idiag_rupuzmphi/=0)  call phisum_mn_name_rz(p%rho*(p%uu(:,1)*p%phix+p%uu(:,2)*p%phiy)*p%uu(:,3),idiag_rupuzmphi)
if (idiag_rurmphi/=0)  call phisum_mn_name_rz(p%rho*(p%uu(:,1)*p%pomx+p%uu(:,2)*p%pomy),idiag_rurmphi)
if (idiag_rupmphi/=0)  call phisum_mn_name_rz(p%rho*(p%uu(:,1)*p%phix+p%uu(:,2)*p%phiy),idiag_rupmphi)
...
if (idiag_fkinrsphmphi/=0)  call phisum_mn_name_rz(p%ekin*(p%uu(:,1)*p%evr(:,1)+  p%uu(:,2)*p%evr(:,2)+p%uu(:,3)*p%evr(:,3)),idiag_fkinrsphmphi)
!
...
if (idiag_uxupmxy/=0 .or. idiag_ruxupmxy/=0 .or. idiag_ux2upmxy/=0 .or.  idiag_fkinxupmxy/=0 .or. idiag_Rxyupmxy/=0 .or. idiag_Rxzupmxy/=0 .or.  idiag_Ryzupmxy/=0) then
where (p%uu(:,1) > 0.)
uus = p%uu(:,1)
...
if (idiag_Rxyupmxy/=0) call  zsum_mn_name_xy(uxmask*f(l1:l2,m,n,iuu_flucx)*f(l1:l2,m,n,iuu_flucy),idiag_Rxyupmxy)
if (idiag_Rxzupmxy/=0) call  zsum_mn_name_xy(uxmask*f(l1:l2,m,n,iuu_flucx)*f(l1:l2,m,n,iuu_flucz),idiag_Rxzupmxy)
if (idiag_Ryzupmxy/=0) call  zsum_mn_name_xy(uxmask*f(l1:l2,m,n,iuu_flucy)*f(l1:l2,m,n,iuu_flucz),idiag_Ryzupmxy)
endif
if (idiag_ffdownmxy/=0  .or. idiag_uxdownmxy/=0 .or. idiag_ruxdownmxy/=0 .or.  idiag_ux2downmxy/=0 .or. idiag_fkinxdownmxy/=0 .or. idiag_Rxydownmxy/=0 .or.  idiag_Rxzdownmxy/=0 .or. idiag_Ryzdownmxy/=0) then
where (p%uu(:,1) < 0.)
uus = p%uu(:,1)
uxmask = -p%uu(:,1)/abs(p%uu(:,1))
elsewhere
...
if (idiag_Rxydownmxy/=0) call  zsum_mn_name_xy(uxmask*f(l1:l2,m,n,iuu_flucx)*f(l1:l2,m,n,iuu_flucy),idiag_Rxydownmxy)
if (idiag_Rxzdownmxy/=0) call  zsum_mn_name_xy(uxmask*f(l1:l2,m,n,iuu_flucx)*f(l1:l2,m,n,iuu_flucz),idiag_Rxzdownmxy)
if (idiag_Ryzdownmxy/=0) call  zsum_mn_name_xy(uxmask*f(l1:l2,m,n,iuu_flucy)*f(l1:l2,m,n,iuu_flucz),idiag_Ryzdownmxy)
endif
else
!
...
if (ivid_uu_sph/=0) call store_slices(p%uu_sph,uu_sph_xy,uu_sph_xz,uu_sph_yz,uu_sph_xy2,  uu_sph_xy3,uu_sph_xy4,uu_sph_xz2,uu_sph_r)
...
enddo
if (lremove_uumeanz.or.lremove_uumeanz_horizontal)  f(:,:,:,iuu+j-1)=f(:,:,:,iuu+j-1)+uum0(j)
enddo
endif
!
...
enddo
if (lremove_uumeanz.or.lremove_uumeanz_horizontal.or.lremove_uumeany)  f(:,:,:,iuu+j-1)=f(:,:,:,iuu+j-1)+uum0(j)
enddo
endif
endif
!
...
case default
write(unit=errormsg,fmt=*)  'set_border_hydro: No such value for borderuu: ',  trim(borderuu(j))
...
print*,'calc_othresh: processor ',iproc_world,': othresh_scl,novec,novecmax=',  othresh_scl,novec,novecmax
...
if (phi/=0.)  call fatal_error("coriolis_cartesian:","not coded if Omega has a y component")
!
...
if (lcentrifugal_force)  call fatal_error("coriolis_spherical_del2p","Centrifugal force not "// "implemented in spherical coordinates")
!
...
pdamp = step(p%rcyl_mn,rdampext,wdamp)
else
pdamp = step(p%r_mn,rdampext,wdamp)
endif
!
...
fext_work=f(l1:l2,m,n,iux)*fext(:,1) +f(l1:l2,m,n,iuy)*fext(:,2) +f(l1:l2,m,n,iuz)*fext(:,3)
...
if (lcylinder_in_a_box) then
pdamp = 1 - step(p%rcyl_mn,rdampint,wdamp)
else
pdamp = 1 - step(p%r_mn,rdampint,wdamp)
endif
...
fint_work=f(l1:l2,m,n,iux)*fint(:,1) +f(l1:l2,m,n,iuy)*fint(:,2) +f(l1:l2,m,n,iuz)*fint(:,3)
...
call parse_name(iname,cname(iname),cform(iname),'uzcx10m',idiag_uzcx10m)
call parse_name(iname,cname(iname),cform(iname),'uzsx10m',idiag_uzsx10m)
...
case ('uu_sph')
call assign_slices_vec(slices,uu_sph_xy,uu_sph_xz,uu_sph_yz,uu_sph_xy2,  uu_sph_xy3,uu_sph_xy4,uu_sph_xz2,uu_sph_r)
!
...
if (first) print*,  "calc_mflow: NOTE: to get umx, uymxy and uzmxy must also be set in zaver"
...
if (first) print*, 'calc_mflow:                    WARNING'
if (first) print*,  "calc_mflow: NOTE: to get umy, uxmxy and uzmxy must also be set in zaver"
...
if (first) print*,"calc_mflow:                    WARNING"
if (first) print*,  "calc_mflow: NOTE: to get umz, uxmz, uymz and uzmz must also be set in xyaver"
if (first) print*,  "calc_mflow:       This may be because we renamed zaver.in into xyaver.in"
if (first) print*,  "calc_mflow:       We proceed, but you'll get umz=0"
umz=0.
else
umz=sqrt(sum(fnamez(:,:,idiag_uxmz)**2  +fnamez(:,:,idiag_uymz)**2  +fnamez(:,:,idiag_uzmz)**2)/(nz*nprocz))
endif
...
omumz=sum(fnamez(:,:,idiag_oxmz)*fnamez(:,:,idiag_uxmz)  +fnamez(:,:,idiag_oymz)*fnamez(:,:,idiag_uymz))/(nz*nprocz)
endif
!
...
umamz=sum(fnamez(:,:,idiag_uxmz)*fnamez(:,:,idiag_axmz)  +fnamez(:,:,idiag_uymz)*fnamez(:,:,idiag_aymz))/(nz*nprocz)
endif
!
...
umbmz=sum(fnamez(:,:,idiag_uxmz)*fnamez(:,:,idiag_bxmz)  +fnamez(:,:,idiag_uymz)*fnamez(:,:,idiag_bymz))/(nz*nprocz)
endif
!
...
umxbmz=sum(fnamez(:,:,idiag_uxmz)*fnamez(:,:,idiag_bymz)  -fnamez(:,:,idiag_uymz)*fnamez(:,:,idiag_bxmz))/(nz*nprocz)
endif
!
...
if (.not.limpose_only_horizontal_uumz)  df(l1:l2,m,n,iuz)=df(l1:l2,m,n,iuz)-tau_diffrot1*(uumz(n,3)-uumz_prof(n-nghost,3))
!
...
call fatal_error('read_omega_profile','no input file omega.dat or'  //trim(directory)//' omega.ascii')
endif
endif
!
...
f(l1:l2,m,n,iux)=amp_meri_circ*(r1_mn**2)*(sin1th(m))*( 2*sin(theta-theta1)*cos(theta-theta1)*cos(theta) -sin(theta)*sin(theta-theta1)**2)* (x(l1:l2)-1.)*(x(l1:l2)-rone)**2
f(l1:l2,m,n,iuy)=-amp_meri_circ*r1_mn*sin1th(m)*( cos(theta)*sin(theta-theta1)**2)* (x(l1:l2)-rone)*(3*x(l1:l2)-rone-2.)
f(l1:l2,m,n,iuz)=0.
enddo
enddo
!
...
call copy_addr(lpressuregradient_gas,p_par(1))
